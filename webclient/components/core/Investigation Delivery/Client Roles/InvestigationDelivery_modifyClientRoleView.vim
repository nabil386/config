...
<VIEW WINDOW_OPTIONS="width=500" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="file://Curam/UIMSchema.xsd">
  ...
  <SERVER_INTERFACE CLASS="Case" NAME="DISPLAY" OPERATION="readClientRole"/>


  <SERVER_INTERFACE CLASS="Case" NAME="ACTION" OPERATION="modifyParticipantRoleComments" PHASE="ACTION"/>
  ...
  <CONNECT>
    <SOURCE NAME="PAGE" PROPERTY="concernCaseRoleID"/>
    <TARGET NAME="DISPLAY" PROPERTY="concernCaseRoleID"/>
  </CONNECT>
  <CONNECT>
    <SOURCE NAME="PAGE" PROPERTY="concernCaseRoleID"/>
