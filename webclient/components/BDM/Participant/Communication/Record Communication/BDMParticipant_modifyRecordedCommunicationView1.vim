...
<SERVER_INTERFACE
  ...
  <CLUSTER NUM_COLS="2">
    ...
    <FIELD LABEL="Field.Label.DateReceived">
      ...
      <!--START: Task 89604: DEV: Enable date field on modify page  -->
      <CONNECT>
        <TARGET
          NAME="ACTION"
          PROPERTY="communicationDate"
      ...
      <!--END: Task 89604: DEV: Enable date field on modify page  -->
    </FIELD>
			   ...
			   <FIELD
			    ...
			    >
			      <CONNECT>
			        <TARGET
			          NAME="ACTION"
			          PROPERTY="modifyRecordedCommDetails$phoneCountryCode"
			        />
			      </CONNECT>
			    </FIELD>
  ...
  <!-- Add file link TASK 91944  -->
 
    
    <!-- TASK 91944 remove file widget  -->
