...
xsi:noNamespaceSchemaLocation="file://Curam/UIMSchema.xsd">
   ...
   <ACTION_SET TYPE="LIST_ROW_MENU">
      <ACTION_CONTROL LABEL="ActionControl.Label.Edit">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="editActionInd" />
         </CONDITION>         
         <LINK OPEN_MODAL="true" PAGE_ID="BDMParticipant_resolveEditCommunicationExternal">
            ...
            <CONNECT>
               <SOURCE NAME="DISPLAY" PROPERTY="result$communicationDtls$commDtls$concernRoleID" />
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.SendNow">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="sendNowActionInd" />
         </CONDITION>
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Preview" TYPE="FILE_DOWNLOAD">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="previewActionInd" />
         </CONDITION>
         <LINK>
            <CONNECT>
               <SOURCE NAME="DISPLAY" PROPERTY="communicationID" />
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.View" TYPE="FILE_DOWNLOAD">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="viewActionInd" />
         </CONDITION>
         <LINK>
            <CONNECT>
               <SOURCE NAME="DISPLAY" PROPERTY="communicationID" />
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Submit">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="submitActionInd" />
         </CONDITION>
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Void">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="voidActionInd" />
         </CONDITION>
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Misdirected">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="misdirectActionInd" />
         </CONDITION>
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Recall">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="recallActionInd" />
         </CONDITION>
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Resubmit">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="resubmitActionInd" />
         </CONDITION>
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.Return">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="returnActionInd" />
         </CONDITION>
      ...
      <ACTION_CONTROL LABEL="ActionControl.Label.EditStatus">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="modifyStatusActionInd" />
         </CONDITION>
      ...
      <ACTION_CONTROL IMAGE="DeleteButton" LABEL="ActionControl.Label.Delete">
         <CONDITION>
            <IS_TRUE NAME="DISPLAY" PROPERTY="deleteActionInd" />
         </CONDITION>
         <LINK OPEN_MODAL="true" SAVE_LINK="true" URI_SOURCE_NAME="DISPLAY" URI_SOURCE_PROPERTY="deletePageName">
            <CONNECT>
               <SOURCE NAME="DISPLAY" PROPERTY="communicationID" />
               <TARGET NAME="PAGE" PROPERTY="communicationID" />
            </CONNECT>
