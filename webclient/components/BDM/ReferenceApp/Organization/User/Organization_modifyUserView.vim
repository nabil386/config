...
>
  ...
  <CONNECT>
    <SOURCE
      NAME="DISPLAY"
      PROPERTY="result$readUserDtls$userDetails$userName"
    />
    <TARGET
      NAME="ACTION"
      PROPERTY="userName"
  ...
  <!-- Begin: Task-11387 A24.1 Create and Manage User Profile by Administrator -->
  <CLUSTER LABEL_WIDTH="50" NUM_COLS="2">
  	
	<FIELD LABEL="Field.Label.Title" WIDTH="40">
		<CONNECT>
	...
	<FIELD LABEL="Field.Label.DefaultLocale">
		<CONNECT>
			<INITIAL NAME="DISPLAY" PROPERTY="defaultLocale" />
		</CONNECT>
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="defaultLocale" />
		</CONNECT>
		<CONNECT>
			<TARGET NAME="ACTION" PROPERTY="defaultLocale" />
		</CONNECT>
	</FIELD>
	...
	<FIELD LABEL="Field.Label.RedirectTasks">
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="assigneeFullName" />
		</CONNECT>
	</FIELD>
	...
	<FIELD LABEL="Field.Label.FirstName">
		...
		<CONNECT>
			<TARGET NAME="ACTION" PROPERTY="firstname" />
		</CONNECT>
	</FIELD>

	<FIELD LABEL="Field.Label.Location">
		<CONNECT>
			<INITIAL NAME="DISPLAY" PROPERTY="locationName" />
		</CONNECT>
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="locationID" />
		</CONNECT>
		<CONNECT>
	...
	<FIELD HEIGHT="2"
		LABEL="Field.Label.userLanguage" USE_BLANK="false" WIDTH="100">
		<CONNECT>
			<INITIAL HIDDEN_PROPERTY="langCode" NAME="DISPLAY"
				PROPERTY="langDesc" />
		</CONNECT>
		<CONNECT>
		...
		<CONNECT>
			<TARGET NAME="ACTION" PROPERTY="userLangList" />
		</CONNECT>
	</FIELD>
...
<!-- End: Task-11387 A24.1 Create and Manage User Profile by Administrator -->
  ...
  <CLUSTER LABEL_WIDTH="50" NUM_COLS="2"
	...
	<CONDITION>
		<IS_FALSE NAME="DISPLAY"
			PROPERTY="result$readUserDtls$userDetails$alternateLoginEnabled" />
	</CONDITION>

	<FIELD LABEL="Field.Label.UserName" EDITABLE="NONEDITABLE">
		<CONNECT>
	...
	<FIELD LABEL="Field.Label.PasswordNew">
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="password" />
		</CONNECT>
		<CONNECT>
			<TARGET NAME="ACTION" PROPERTY="password" />
		</CONNECT>
	</FIELD>
	<FIELD LABEL="Field.Label.PasswordExpiryDays" WIDTH="30">
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="passwordExpiry" />
		</CONNECT>
		<CONNECT>
			<TARGET NAME="ACTION" PROPERTY="passwordExpiry" />
		</CONNECT>
	</FIELD>
	<FIELD LABEL="Field.Label.Application" USE_BLANK="true"
		USE_DEFAULT="false">
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="applicationCode" />
		</CONNECT>
		<CONNECT>
			<TARGET NAME="ACTION" PROPERTY="applicationCode" />
		</CONNECT>
	</FIELD>


	<FIELD LABEL="Field.Label.AccountExpiry" USE_DEFAULT="false">
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="passwordExpiresOn" />
		</CONNECT>
		<CONNECT>
			<TARGET NAME="ACTION" PROPERTY="passwordExpiresOn" />
		</CONNECT>
	</FIELD>
	<FIELD LABEL="Field.Label.CallCentreUser">
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="ctiEnabled" />
		</CONNECT>
		<CONNECT>
			<TARGET NAME="ACTION" PROPERTY="ctiEnabled" />
		</CONNECT>
	</FIELD>
	<FIELD CONTROL="SKIP"></FIELD>

	<FIELD LABEL="Field.Label.PasswordConfirm">
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="passwordConfirm" />
		</CONNECT>
		<CONNECT>
			<TARGET NAME="ACTION" PROPERTY="passwordConfirm" />
		</CONNECT>
	</FIELD>
	<FIELD LABEL="Field.Label.PasswordExpiryLogin"
		USE_DEFAULT="false" WIDTH="30">
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="pwdChangeAfterXLog" />
		</CONNECT>
		<CONNECT>
			<TARGET NAME="ACTION" PROPERTY="pwdChangeAfterXLog" />
		</CONNECT>
	</FIELD>
	<FIELD LABEL="Field.Label.RoleName">
		<CONNECT>
			<INITIAL NAME="DISPLAY" PROPERTY="roleName" />
		</CONNECT>
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="roleName" />
		</CONNECT>
		<CONNECT>
			<TARGET NAME="ACTION" PROPERTY="roleName" />
		</CONNECT>
	</FIELD>
	<CONTAINER LABEL="Field.Label.AccountEnabled">
		<FIELD LABEL="Field.Label.AccountEnabled">
			<CONNECT>
				<SOURCE NAME="DISPLAY" PROPERTY="accountEnabled" />
			</CONNECT>
		</FIELD>
	</CONTAINER>
  </CLUSTER>  
  ...
  <CLUSTER LABEL_WIDTH="50" NUM_COLS="2"
	...
	<FIELD LABEL="Field.Label.LoginID" USE_BLANK="true"
		USE_DEFAULT="false" EDITABLE="NONEDITABLE">
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="loginID" />
		</CONNECT>
	</FIELD>
	...
	<FIELD LABEL="Field.Label.SamAccountName" USE_BLANK="true"
		USE_DEFAULT="false">
		<CONNECT>
			<SOURCE NAME="DISPLAY" PROPERTY="samAccountName" />
		</CONNECT>
	</FIELD>	
