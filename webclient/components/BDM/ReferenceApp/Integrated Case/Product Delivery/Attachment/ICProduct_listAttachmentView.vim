...
<!-- START : TASK 12776  Custom implementation for List Attachment page -->
	<SERVER_INTERFACE CLASS="BDMIntegratedCase"
		NAME="DISPLAY" OPERATION="listProductDeliveryAttachment" />
<!-- END : TASK 12776  Custom implementation for List Attachment page -->
