  ...
  <LIST>
    ...
    <FIELD WIDTH="3">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="result$dtls$dtls$reservedByExistsInd"
        />
      </CONNECT>
    </FIELD>
    <FIELD
    ...
    >
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="result$dtls$dtls$subject"
        />
      </CONNECT>
    </FIELD>
     ...
     <!-- Start: TASk 86600  -->
   <FIELD
      LABEL="Field.Title.CaseUrgentFlag"
      WIDTH="20"
    >
      ...
      <FIELD
      LABEL="Field.Title.EscalationLevel"
      WIDTH="20"
	    >
    ...
    >
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="result$dtls$dtls$dueDateTime"
        />
      </CONNECT>
    </FIELD>
  </LIST>
