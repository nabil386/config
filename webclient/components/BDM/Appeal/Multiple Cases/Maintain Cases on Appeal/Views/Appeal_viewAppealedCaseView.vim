...
>
  ...
  <SERVER_INTERFACE
    CLASS="BDMAppealedCase"
    NAME="DISPLAY"
    OPERATION="readItemUnderAppealDetails"
    PHASE="DISPLAY"
  />
  ...
  <CONNECT>
    ...
    <TARGET
      NAME="DISPLAY"
      PROPERTY="appealRelationshipKey$appealRelationshipID"
    />
  </CONNECT>
  ...
  >
    <FIELD LABEL="Field.Label.Comments">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="readSummaryDetails$comments"
        />
      </CONNECT>
    </FIELD>
  </CLUSTER>
  ...
  <LIST TITLE="List.Title.Issues">
    ...
    <ACTION_SET TYPE="LIST_ROW_MENU">
      <ACTION_CONTROL LABEL="ActionControl.Label.EditIssue">
	      <CONDITION>
	      	<IS_TRUE NAME="DISPLAY" PROPERTY="issueEditEnabledInd"/>
	      </CONDITION>
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="BDM_editRFRIssue"
        >
          <CONNECT>
            <SOURCE
              NAME="DISPLAY"
              PROPERTY="bdmRFRIssueID"
            />
            <TARGET
              NAME="PAGE"
              PROPERTY="bdmRFRIssueID"
		  ...
		  <CONNECT>
            <SOURCE
              NAME="DISPLAY"
              PROPERTY="issueDtls$appealRelationshipID"
            />
            <TARGET
              NAME="PAGE"
              PROPERTY="appealRelationshipID"
      ...
      <ACTION_CONTROL
        IMAGE="RemoveButton"
        LABEL="ActionControl.Label.RemoveIssue"
      >
     	 <CONDITION>
	      	<IS_TRUE NAME="DISPLAY" PROPERTY="issueDeleteEnabledInd"/>
	      </CONDITION>
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="BDM_deleteRFRIssue"
        >
         <CONNECT>
            <SOURCE
              NAME="DISPLAY"
    ...
    <FIELD LABEL="Field.Label.IssueType" WIDTH="40">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="issueType"
    ...
    <FIELD LABEL="Field.Label.Level" WIDTH="15">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="issueLevel"
    ...
    <FIELD LABEL="Field.Label.CreationDate" WIDTH="15">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
    ...
    <FIELD LABEL="Field.Label.IssueDecision" WIDTH="15" >
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="decision"
    ...
    <DETAILS_ROW>
      <INLINE_PAGE PAGE_ID="BDM_viewRFRIssueDetails">
        <CONNECT>
            <SOURCE
              NAME="DISPLAY"
              PROPERTY="bdmRFRIssueID"
