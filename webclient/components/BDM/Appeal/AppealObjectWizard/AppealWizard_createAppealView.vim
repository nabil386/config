...
<VIEW>
  ...
  <CLUSTER TITLE="Cluster.Title.AppealedCaseDetails">  
    <CLUSTER
      ...
      NUM_COLS="2"
    >
      <FIELD LABEL="Field.Label.ADMSReference">
        <CONNECT>
          <SOURCE
            NAME="DISPLAYWIZARD"
            PROPERTY="admsReference"
          />
        </CONNECT>
        <CONNECT>
          <TARGET
      ...
      <FIELD LABEL="Field.Label.DateDecisionDisputed">
        <CONNECT>
          <SOURCE
            NAME="DISPLAYWIZARD"
            PROPERTY="dateDecisionDisputed"
          />
        </CONNECT>
        <CONNECT>
          <TARGET
      ...
      <FIELD LABEL="Field.Label.RFRReceivedDate">
        <CONNECT>
          <SOURCE
            NAME="DISPLAYWIZARD"
            PROPERTY="dateRFRReceived"
          />
        </CONNECT>
        <CONNECT>
          <TARGET
    ...
    <CLUSTER
      TITLE="Cluster.Title.AppealedCaseItemUnderAppeal"
      LABEL_WIDTH="50"
      NUM_COLS="2"
    >
