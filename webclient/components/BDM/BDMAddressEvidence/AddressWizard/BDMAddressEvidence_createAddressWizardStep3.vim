...
>
 ...
 <CONNECT>
    <SOURCE NAME="CONSTANT" PROPERTY="CreateAddressEvidenceWizardStep3" />
...
<TARGET NAME="ACTION" PROPERTY="wizardDtls$caseParticipantRoleID"/>
  ...
  <ACTION_SET BOTTOM="true">
	<ACTION_CONTROL LABEL="ActionControl.Label.Back">
      <LINK DISMISS_MODAL="false" PAGE_ID="BDMAddressEvidence_createAddressWizardStep2" SAVE_LINK="false"
      >
        <CONNECT>
          <SOURCE  NAME="PAGE" PROPERTY="wizardStateID"  />
