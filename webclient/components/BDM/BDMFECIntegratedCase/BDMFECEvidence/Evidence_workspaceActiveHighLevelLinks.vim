...
<VIEW xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<ACTION_CONTROL LABEL="ActionControl.Label.NewEvidence">
		<LINK OPEN_MODAL="true" PAGE_ID="Evidence_addNewEvidence">
			<CONNECT>
	...
	<ACTION_CONTROL
		LABEL="ActionControl.Label.OpenEvidenceTab">
	...
	<ACTION_CONTROL LABEL="ActionControl.Label.ApplyChanges">
		<CONDITION>
			<IS_TRUE NAME="DISPLAYLINK"
				PROPERTY="isUserAllowedToApplyEvidence" />
		</CONDITION>	
		<LINK OPEN_MODAL="true" PAGE_ID="Evidence_applyChanges1">
			<CONNECT>
				<SOURCE NAME="PAGE" PROPERTY="caseID" />
				<TARGET NAME="PAGE" PROPERTY="caseID" />
			</CONNECT>
	...
	<ACTION_CONTROL
		...
		<LINK OPEN_MODAL="true" PAGE_ID="Evidence_validateChanges">
			<CONNECT>
				<SOURCE NAME="PAGE" PROPERTY="caseID" />
				<TARGET NAME="PAGE" PROPERTY="caseID" />
			</CONNECT>
	...
	<ACTION_CONTROL IMAGE="TransferEvidence"
	...
	<ACTION_CONTROL LABEL="ActionControl.Label.Approve">
		<LINK OPEN_MODAL="true" PAGE_ID="Evidence_approveApprovalRequest">
			<CONNECT>
				<SOURCE NAME="PAGE" PROPERTY="caseID" />
				<TARGET NAME="PAGE" PROPERTY="caseID" />
			</CONNECT>
	...
	<ACTION_CONTROL LABEL="ActionControl.Label.Reject">
		<LINK OPEN_MODAL="true" PAGE_ID="Evidence_rejectApprovalRequests">
			<CONNECT>
				<SOURCE NAME="PAGE" PROPERTY="caseID" />
				<TARGET NAME="PAGE" PROPERTY="caseID" />
			</CONNECT>
