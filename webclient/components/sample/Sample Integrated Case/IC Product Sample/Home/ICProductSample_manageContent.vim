  ...
  <CLUSTER SHOW_LABELS="false">
    ...
    <CONTAINER>
      <ACTION_CONTROL IMAGE="ActivateIcon" LABEL="Field.StaticText.OnlineActivate">
        <LINK OPEN_MODAL="true" PAGE_ID="ProductDelivery_activate" WINDOW_OPTIONS="width=580,height=150">
          <CONNECT>
            <SOURCE NAME="PAGE" PROPERTY="caseID"/>
            <TARGET NAME="PAGE" PROPERTY="caseID"/>
          </CONNECT>
  ...
  <CLUSTER SHOW_LABELS="false">
    <CONTAINER>
      <ACTION_CONTROL IMAGE="ApproveIcon" LABEL="Field.StaticText.Approve">
        <LINK OPEN_MODAL="true" PAGE_ID="ProductDelivery_approve" WINDOW_OPTIONS="width=400,height=150">
          <CONNECT>
            <SOURCE NAME="PAGE" PROPERTY="caseID"/>
            <TARGET NAME="PAGE" PROPERTY="caseID"/>
          </CONNECT>
    ...
    <CONTAINER>
      <ACTION_CONTROL IMAGE="RejectIcon" LABEL="Field.StaticText.Reject">
        <LINK OPEN_MODAL="true" PAGE_ID="ProductDelivery_reject" WINDOW_OPTIONS="width=710">
          <CONNECT>
            <SOURCE NAME="PAGE" PROPERTY="caseID"/>
            <TARGET NAME="PAGE" PROPERTY="caseID"/>
          </CONNECT>
    ...
    <CONTAINER>
      <ACTION_CONTROL IMAGE="ReassessIcon" LABEL="ActionControl.Label.Reassess">
        <LINK OPEN_MODAL="true" PAGE_ID="ProductDelivery_reassessBenefit" WINDOW_OPTIONS="width=800">
          <CONNECT>
            <SOURCE NAME="PAGE" PROPERTY="caseID"/>
            <TARGET NAME="PAGE" PROPERTY="caseID"/>
          </CONNECT>
  ...
  <CLUSTER SHOW_LABELS="false">
    <CONTAINER>
      <ACTION_CONTROL IMAGE="SuspendIcon" LABEL="Field.StaticText.Suspend">
        <LINK OPEN_MODAL="true" PAGE_ID="ProductDelivery_suspend" WINDOW_OPTIONS="width=800">
          <CONNECT>
            <SOURCE NAME="PAGE" PROPERTY="caseID"/>
            <TARGET NAME="PAGE" PROPERTY="caseID"/>
          </CONNECT>
    ...
    <CONTAINER>
      <ACTION_CONTROL IMAGE="UnsuspendIcon" LABEL="Field.StaticText.Unsuspend">
        <LINK OPEN_MODAL="true" PAGE_ID="ProductDelivery_unsuspend" WINDOW_OPTIONS="width=800">
          <CONNECT>
            <SOURCE NAME="PAGE" PROPERTY="caseID"/>
            <TARGET NAME="PAGE" PROPERTY="caseID"/>
          </CONNECT>
    ...
    <CONTAINER>
      <ACTION_CONTROL IMAGE="ReactivateIcon" LABEL="Field.StaticText.Reactivate">
        <LINK OPEN_MODAL="true" PAGE_ID="ProductDelivery_reactivate" WINDOW_OPTIONS="width=825">
          <CONNECT>
            <SOURCE NAME="PAGE" PROPERTY="caseID"/>
            <TARGET NAME="PAGE" PROPERTY="caseID"/>
          </CONNECT>
