...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!-- The included view to display a list of representatives                 -->
<VIEW
...
>
  ...
  <SERVER_INTERFACE
    ...
    NAME="DISPLAY"
    OPERATION="viewHearingRepresentativeListByHearingID"
    PHASE="DISPLAY"
  />
  ...
  <LIST>
    <DETAILS_ROW>
      <INLINE_PAGE PAGE_ID="Appeal_viewRepresentative">
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
    ...
    <ACTION_SET TYPE="LIST_ROW_MENU">
      <ACTION_CONTROL LABEL="ActionControl.Label.Edit">
        <LINK
          OPEN_MODAL="true"
          PAGE_ID="Appeal_modifyRepresentativeFromList"
        >
          <CONNECT>
            <SOURCE
              NAME="DISPLAY"
