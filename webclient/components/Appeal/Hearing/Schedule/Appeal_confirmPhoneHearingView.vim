...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!-- This page allows the user to confirm telephone hearing.                -->
<?curam-deprecated Since Curam 6.0 SP2, replaced with Appeal_confirmPhoneHearingTypeView.vim.
  This page does not have access to a hearingType page parameter.?>
<VIEW
...
>
  ...
  <SERVER_INTERFACE
    ...
    NAME="ACTION"
    OPERATION="schedulePhoneHearing"
    PHASE="ACTION"
  />
