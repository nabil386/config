...
<!-- Description -->
<!-- =========== -->
<!-- This page allows user to modify transcription requests.                -->
<VIEW
...
>
  ...
  >
    <FIELD LABEL="Field.Label.Transcriber">
    ...
    <FIELD LABEL="Field.Label.RequestedBy">
      ...
      <LINK
        OPEN_NEW="TRUE"
        PAGE_ID="Appeal_resolveParticipantHome"
      >
