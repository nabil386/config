...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!-- This page is a view for creating a new judicial review case where      -->
...
>
  ...
  <CONNECT>
    ...
    <TARGET
      NAME="ACTION"
      PROPERTY="appealCreateCaseDetails$caseID"
    />
  </CONNECT>
  ...
  <CLUSTER
    LABEL_WIDTH="45"
    NUM_COLS="2"
    TITLE="Cluster.Title.JudicialReviewDetails"
  >
    ...
    <FIELD LABEL="Field.Label.Respondent">
      <CONNECT>
        <SOURCE
          NAME="DISPLAY"
          PROPERTY="respondentDisplayName"
        />
      </CONNECT>
    </FIELD>
