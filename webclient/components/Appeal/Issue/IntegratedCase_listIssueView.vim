...
-->
<!-- Copyright 2007, 2010-11 Curam Software Ltd.                            -->
<!-- All rights reserved.                                                   -->
...
<!-- Description                                                            -->
<!-- ===========                                                            -->
<!-- This page allows user to display a list of issues.                     -->
<VIEW
  ...
  <LIST>
    <ACTION_SET TYPE="LIST_ROW_MENU">
      <ACTION_CONTROL LABEL="ActionControl.Label.Edit">
        <LINK PAGE_ID="IssueDelivery_modifyIssueFromList">
          <CONNECT>
            <SOURCE
              NAME="DISPLAY"
    ...
    >
      ...
      <LINK PAGE_ID="IntegratedCase_resolveParticipantHome">
        <CONNECT>
          <SOURCE
            NAME="DISPLAY"
            PROPERTY="result$dtlsList$dtls$caseParticipantRoleID"
          />
          <TARGET
            NAME="PAGE"
