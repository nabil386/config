...
>
  ...
  >
    ...
    <FIELD LABEL="Field.Label.Type" USE_BLANK="TRUE"
        USE_DEFAULT="FALSE">
	<CONNECT>
        <SOURCE NAME="DISPLAY_SEARCH_CRITERIA" PROPERTY="typeCode"/>
      </CONNECT>
      <CONNECT>
        <TARGET NAME="ACTION" PROPERTY="typeCode"/>
      </CONNECT>
    </FIELD>    
    <!-- END TASK 67230 -->   
...
<!-- BEGIN TASK 67230: Commented Bank Details and Contact details clusters -->
<!-- 
  <CLUSTER
    LABEL_WIDTH="40"
    NUM_COLS="2"
