...
<!-- owner.                                                              -->
<VIEW WINDOW_OPTIONS="width=750" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
  ...
  <SERVER_INTERFACE CLASS="BDMOASCase" NAME="ACTION" OPERATION="createCaseOwner" PHASE="ACTION"/>
  ...
  <CLUSTER LABEL_WIDTH="28" NUM_COLS="2">
	...
	<FIELD
      LABEL="Field.Label.IsManuallyChanged"
    >
      <CONNECT>
        <TARGET
          NAME="ACTION"
