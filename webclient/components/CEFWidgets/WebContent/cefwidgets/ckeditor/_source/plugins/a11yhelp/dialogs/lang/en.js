	...
	[
		...
		},
		{
			...
			[
				...
				{
					name: ' Permanent Pen',
					legend: 'Press ${ibmpermanentpen} (Alt+Cmd+T on MAC) inside the editor to activate/deactivate the permanent pen.'
				},
				{
					name: ' Copy Formatting',
					legend: 'Press ${copyFormatting} inside the editor to copy the format of the selected text, and ${applyFormatting} to apply the copied format to the current selection'
				},
				{
