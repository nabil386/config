 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'en', {
	...
	ibm : 
	{
        ...
        insertButtonTitle : "Insert Image",
		previewText : "Text will flow around the image you are adding like in this example.",
        imageLinkLabel : "Add a link that will open when the image is clicked.",
		fileUpload : "Select an image file from your computer:",
        browseFile : "Choose File",
        noFileChosen : "No file chosen",
        notImageFile: "Please select an image file.",
        fileUploadTimeout : "Inserting the image took too long and the action timed out. Try again or cancel.",
	serverUnreachable : "The server is currently unreachable. Please contact your system administrator and try again later.",
        linkLabel:"Link:",
        imageSize: "The image is too large. Select another image or cancel.",
        inserting: "Inserting...",
        enableActiveX: "Please ensure ActiveX is enabled for Internet Explorer.",
        file: "File"
	}
});