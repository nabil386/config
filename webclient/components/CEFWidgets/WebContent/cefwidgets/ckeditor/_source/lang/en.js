...
CKEDITOR.lang['en'] = {
    ...
    ibmwidgets : 
    {
    	ariaNotification : 'Video selected, press ENTER to access video controllers',
    	iframeAriaNotification : 'IFrame selected',
    	imgAriaNotification : 'Picture selected',
    	mediaObjectAriaNotification : 'Media object selected',
    	properties : 'Media Properties',
    	focusBackNotification : 'Press ESC to focus back to the editor'
    },
    ibmurllink : 
    {
    	title : 'URL Link',
    ...
    ibmpastemedialink : 
    {
    	widgetNotification : 'The pasted URL was identified as containing social media content, and has been automatically converted into an a widget embedding the rich media content'
    },
    ibmmenuhelpmessage : 
    {
    ...
    ibminsertmedia : 
    {
    	wrongVisibility : 'Error embedding the media selected\nThe visibility must be public.',
    	badResponse : 'The embed media has moved or no longer exists',
    	timeout : 'Embed request timed out\nPlease try again.'
    },
    ibmimagedatauri : 
    {
    ...
    clipboard : 
    {
    	...
    	title : 'Paste',
    	fakepath : 'Pasting images is currently not supported. Please use the \'Insert Image\' toolbar option instead.'
    },
    button : 
    {
