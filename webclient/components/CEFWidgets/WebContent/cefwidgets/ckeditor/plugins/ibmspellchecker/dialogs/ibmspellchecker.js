/* Copyright IBM Corp. 2009-2016  All Rights Reserved. *//* Copyright IBM Corp. 2010-2016 All Rights Reserved.  */
(function()
{
	/**
	 ...
	 */
    // Added MS smart quotes (‘’“”) to the regex here to reimplement fix from RTC ticket 149431
	...
	WordWalker.prototype =
	{
		...
		{
			return (node.type == CKEDITOR.NODE_TEXT && node.getText().length > 0 && node.getText().search(/(?:^|\\s)/) != -1);
		},
