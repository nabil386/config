...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="HEARINGOFF"
 logo="HEARINGOFF.logo"
 title="HEARINGOFF.title"
 subtitle="HEARINGOFF.subtitle"
 user-message="HEARINGOFF.UserMessage">
  ...
  <ac:section-ref id="HEARINGOFFHomeSection"/>
  <ac:section-ref id="HEARINGOFFWorkspaceSection"/>
