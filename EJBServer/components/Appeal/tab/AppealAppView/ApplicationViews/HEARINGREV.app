...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="HEARINGREV"
 logo="HEARINGREV.logo"
 title="HEARINGREV.title"
 subtitle="HEARINGREV.subtitle"
 user-message="HEARINGREV.UserMessage">
  ...
  <ac:section-ref id="HEARINGREVHomeSection"/>
  <ac:section-ref id="HEARINGREVWorkspaceSection"/>
