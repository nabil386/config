...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="HEARINGSCH"
 logo="HEARINGSCH.logo"
 title="HEARINGSCH.title"
 subtitle="HEARINGSCH.subtitle"
 user-message="HEARINGSCH.UserMessage">
  ...
  <ac:section-ref id="HEARINGSCHHomeSection"/>
  <ac:section-ref id="HEARINGSCHWorkspaceSection"/>
