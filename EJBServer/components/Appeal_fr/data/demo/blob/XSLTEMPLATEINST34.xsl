                                          ...
                                          <fo:block>
                                            ...
                                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                              <fo:block>
                                                ...
                                                <fo:inline font-size="12pt">Cette audience aura lieu aux date et heure mentionnées ci-dessous :</fo:inline>
                                                <fo:block>
                                                  <fo:leader leader-pattern="space" />
                                                </fo:block>
                                                <fo:block>
                                                                      ...
                                                                      <fo:block text-align="left">
                                                                        ...
                                                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                                                          <fo:block text-align="left">
                                                                            ...
                                                                            <fo:inline font-size="10pt">Si vous êtes dans l'incapacité de comparaître aux date et heure prévues, vous pouvez demander un ajournement. Celui-ci sera accordé uniquement en cas de motif valide. </fo:inline>
                                                                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                              <fo:block>
                                                                                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                                  <fo:block text-align="justify">
