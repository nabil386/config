                                  ...
                                  <fo:block>
                                    <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                      <fo:block>
                                        ...
                                        <fo:inline font-size="12pt">Suite à votre demande, l'examen de votre audience se tiendra à la date suivante :</fo:inline>
                                        <fo:block>
                                          <fo:leader leader-pattern="space" />
                                        </fo:block>
                                        <fo:block>
                                                                  ...
                                                                  <fo:block>
                                                                    ...
                                                                    <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                      <fo:block>
                                                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                          <fo:block>
                                                                            <fo:inline font-size="10pt">Si vous souhaitez Annuler l'audience, veuillez signer la déclaration ci-dessous et retourner cet avis à :</fo:inline>
                                                                            <fo:block>
                                                                              <fo:leader leader-pattern="space" />
                                                                            </fo:block>
                                                                            <fo:inline font-size="10pt">
