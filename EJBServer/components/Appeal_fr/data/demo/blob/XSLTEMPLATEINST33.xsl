                                          ...
                                          <fo:block>
                                            ...
                                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                              <fo:block>
                                                ...
                                                <fo:inline font-size="12pt">
                                                  Vous avez été sélectionné par <xsl:apply-templates select="FIELD[FNAME='appellantName']" /> pour le représenter lors d'une audience aux date et lieu mentionnés ci-dessous :
                                                </fo:inline>
                                                <fo:block>
                                                  <fo:leader leader-pattern="space" />
                                                </fo:block>
                                                                      ...
                                                                      <fo:block text-align="left">
                                                                        ...
                                                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                                                          <fo:block text-align="left">
                                                                            ...
                                                                            <fo:inline font-size="10pt">
                                                                              En cas de retard, vous devrez peut-être renoncer à votre audience. Si vous ne vous présentez pas à une audience prévue, votre demande sera considérée abandonnée, sauf si, dans les <xsl:apply-templates select="FIELD[FNAME='appealTimeLimit']" /> jours suivant la date prévue, vous demandez un report d'audience et fournissez une raison valable pour justifier votre manquement à comparaître.
                                                                            </fo:inline>
                                                                            <fo:block>
                                                                              <xsl:text />
                                                                            </fo:block>
