          ...
          <fo:block>
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              <fo:block text-align="center">
                <fo:inline font-size="14pt" font-weight="bold">Assignation à comparaître en tant que témoin pour une audience</fo:inline>
                <fo:block>
                                                              ...
                                                              <fo:block text-align="justify">
                                                                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                  <fo:block>
                                                                    ...
                                                                    <fo:inline font-size="10pt">Toute question relative au présent avis est à adresser à la partie ayant sollicité votre comparution. Si vous n'êtes pas en mesure de comparaître à l'audience ou de produire les documents demandés pour un motif valide, vous devez en informer le responsable de l'audience.
                                                                      Tout manquement à comparaître et à produire les documents demandés est passible de sanctions.</fo:inline>
                                                                  </fo:block>
                                                                </fo:block>
                                                              </fo:block>
                                                            </fo:block>
