                                  ...
                                  <fo:block>
                                    <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                      <fo:block>
                                        ...
                                        <fo:inline font-size="12pt">Vous êtes par la présente assigné à officier en tant qu'interprète lors d'une audience pour :</fo:inline>
                                        <fo:block>
                                          <fo:leader leader-pattern="space" />
                                        </fo:block>
                                        <fo:block>
                                                          ...
                                                          <fo:block>
                                                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                              <fo:block text-align="justify">
                                                                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                  <fo:block>
                                                                    <fo:inline font-size="10pt">Veuillez vous présenter à l'audience à l'heure et au lieu suivants, ou prendre contact avec :</fo:inline>
                                                                    <fo:block>
                                                                      <fo:leader leader-pattern="space" />
                                                                    </fo:block>
                                                                    <fo:block>
