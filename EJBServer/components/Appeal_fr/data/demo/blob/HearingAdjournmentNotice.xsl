        ...
        <fo:flow flow-name="xsl-region-body" font-family="WT Sans">
          ...
          <fo:block text-align="center">
            <fo:inline font-weight="bold">
              <fo:inline xsl:use-attribute-sets="Normal_1">Avis d'ajournement d'audience</fo:inline>
            </fo:inline>
          </fo:block>
            ...
            <fo:table-body>
                ...
                <fo:table-cell xsl:use-attribute-sets="Cell_1">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Référence du dossier :</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Type d'action en justice :</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Dossier concernant :</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="Cell_4">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">
                        <xsl:apply-templates select="FIELD[FNAME='participantName']" />
                      </fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Concernant :</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="Cell_4">
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Date d'audience d'origine :</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="Cell_4">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">
                        <xsl:apply-templates select="FIELD[FNAME='hearingScheduleDate']" />
                      </fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Date d'audience ajournée :</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="Cell_4">
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Motif :</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="Cell_4">
          ...
          <fo:block xsl:use-attribute-sets="Normal_3">
            <fo:inline xsl:use-attribute-sets="Normal_2">Par la présente, nous vous informons que l'audience susmentionnée a été ajournée. Nous vous informerons lorsque la prochaine audience sera planifiée.</fo:inline>
          </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_3">
            <fo:inline xsl:use-attribute-sets="Normal_2"> </fo:inline>
          </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_3">
            <fo:inline xsl:use-attribute-sets="Normal_2">Cordialement,</fo:inline>
          </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_3">
            <fo:inline xsl:use-attribute-sets="Normal_2"> </fo:inline>
          </fo:block>
