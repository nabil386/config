                                  ...
                                  <fo:block>
                                    <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                      <fo:block>
                                        ...
                                        <fo:inline font-size="12pt">Suite à votre requête, votre audience aura lieu aux date et heure mentionnées ci-dessous :</fo:inline>
                                        <fo:block>
                                          <fo:leader leader-pattern="space" />
                                        </fo:block>
                                        <fo:block>
                                                                    ...
                                                                    <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                      <fo:block text-align="justify">
                                                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                          <fo:block>
                                                                            <fo:inline font-size="10pt">
                                                                              En cas de retard, vous devrez peut-être renoncer à votre audience. Si votre représentant ou vous-même ne vous présentez pas à une audience prévue, votre demande sera considérée abandonnée, sauf si, dans les <xsl:apply-templates select="FIELD[FNAME='appealTimeLimit']" /> suivant la date prévue, votre représentant ou vous-même demandez un report d'audience et fournissez une raison valable pour justifier votre manquement à comparaître.
                                                                            </fo:inline>
                                                                            <fo:block>
                                                                              <xsl:text />
                                                                            </fo:block>
