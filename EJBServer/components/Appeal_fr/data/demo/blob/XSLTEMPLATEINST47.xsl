          ...
          <fo:block>
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              <fo:block text-align="center">
                <fo:inline font-size="14pt" font-weight="bold">Assignation à comparaître en tant que témoin pour une audience téléphonique</fo:inline>
                <fo:block>
