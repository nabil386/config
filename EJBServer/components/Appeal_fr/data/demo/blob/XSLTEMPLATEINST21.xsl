          ...
          <fo:block>
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              <fo:block text-align="center">
                <fo:inline font-size="14pt" font-weight="bold">Notification d'ajournement d'audience</fo:inline>
                <fo:block>
                                      ...
                                      <fo:block>
                                        ...
                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                          <fo:block text-align="left">
                                            ...
                                            <fo:inline font-size="12pt">
                                              Le <xsl:apply-templates select="FIELD[FNAME='continuanceDate']" />, une demande d'ajournement de l'audience ci-dessus a été déposée pour le motif suivant :
                                            </fo:inline>
                                            <fo:block>
                                              <fo:leader leader-pattern="space" />
                                            </fo:block>
                                              ...
                                              <fo:block>
                                                ...
                                                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                  <fo:block text-align="left">
                                                    ...
                                                    <fo:inline font-size="12pt">
                                                      Cette raison a été jugée valide et ce report a été accordé. La présente notification annonce que cette audience planifiée le <xsl:apply-templates select="FIELD[FNAME='scheduledDate']" /> est désormais reportée à une date ultérieure.
                                                    </fo:inline>
                                                    <fo:block>
                                                      <fo:leader leader-pattern="space" />
                                                    </fo:block>
                                                    <fo:inline font-size="12pt">Vous recevrez une autre notification vous informant de la date, de l'heure et du lieu de l'audience reportée.</fo:inline>
                                                    <fo:block>
                                                      <fo:leader leader-pattern="space" />
                                                    </fo:block>
