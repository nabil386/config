          ...
          <fo:block>
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              <fo:block text-align="center">
                <fo:inline font-size="14pt" font-weight="bold">Avis d'audience sur lieu de travail</fo:inline>
                <fo:block>
                                  ...
                                  <fo:block>
                                    <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                      <fo:block>
                                        ...
                                        <fo:inline font-size="12pt">En réponse à votre demande, une audience sera planifiée. En voici les détails :</fo:inline>
                                        <fo:block>
                                          <fo:leader leader-pattern="space" />
                                        </fo:block>
                                        <fo:block>
                                        ...
                                        <fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
                                          ...
                                          <fo:table-body>
                                            ...
                                            <fo:table-row>
                                              <fo:table-cell width="160pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                                <fo:block>
                                                  <fo:inline font-size="12pt" font-weight="normal">Date prévue :</fo:inline>
                                                </fo:block>
                                              </fo:table-cell>
                                              <fo:table-cell padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                                <fo:block>
                                        ...
                                        <fo:inline font-size="12pt">
                                          Cette audience aura lieu le <xsl:apply-templates select="FIELD[FNAME='scheduledDate']" />.
                                        </fo:inline>
                                        <fo:block>
                                          <fo:leader leader-pattern="space" />
                                        </fo:block>
                                        ...
                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                          <fo:block text-align="justify">
                                            <fo:inline font-size="10pt">
                                              Si vous souhaitez présenter des documents au cours de l'audience, une copie de ces documents doit être reçue au moins <xsl:apply-templates select="FIELD[FNAME='statementTimeLimit']" /> jours avant la date prévue de l'audience. Si vous avez besoin d'un délai supplémentaire avant l'examen d'audience, vous pouvez solliciter un ajournement en prenant contact avec :
                                            </fo:inline>
                                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                              <fo:block text-align="justify">
                                                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                              ...
                                                              <fo:block text-align="justify">
                                                                ...
                                                                <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                                                  <fo:block text-align="left">
                                                                    ...
                                                                    <fo:inline font-size="10pt">Celui-ci sera accordé uniquement en cas de motif valide. Si vous ne souhaitez plus être entendu dans le cadre d'une audience, veuillez signer la décharge ci-dessous et retourner la présente notification à l'adresse ci-dessous :</fo:inline>
                                                                    <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                      <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                                        <fo:block text-align="justify">
                                                                          <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
