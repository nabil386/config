        ...
        <fo:flow flow-name="xsl-region-body" font-family="WT Sans">
          ...
          <fo:block text-align="center">
            <fo:inline font-weight="bold">
              <fo:inline xsl:use-attribute-sets="Normal_1">Déclaration d'audience</fo:inline>
            </fo:inline>
          </fo:block>
            ...
            <fo:table-body>
                ...
                <fo:table-cell xsl:use-attribute-sets="Cell_1">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Numéro de dossier :</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Date de l'audience</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="Cell_4">
              ...
              <fo:table-row>
                <fo:table-cell xsl:use-attribute-sets="Cell_3">
                  <fo:block xsl:use-attribute-sets="Normal_3">
                    <fo:inline xsl:use-attribute-sets="Normal_3">
                      <fo:inline xsl:use-attribute-sets="Normal_2">Déclaration soumise par :</fo:inline>
                    </fo:inline>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="Cell_4">
          ...
          <fo:block xsl:use-attribute-sets="Normal_3">
            <fo:inline xsl:use-attribute-sets="Normal_2">Chère Madame, cher Monsieur,</fo:inline>
          </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_3">
            <fo:inline xsl:use-attribute-sets="Normal_2"> </fo:inline>
          </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_3">
            <fo:inline xsl:use-attribute-sets="Normal_2">Veuillez trouver ci-joint la copie d'une déclaration comprise dans le dossier de l'audience susmentionnée. En tant que partie à cette audience, vous êtes habilité à examiner une copie de cette déclaration avant l'audience.</fo:inline>
          </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_3">
            <fo:inline xsl:use-attribute-sets="Normal_2"> </fo:inline>
          </fo:block>
