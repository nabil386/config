          ...
          <fo:block>
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              <fo:block text-align="center">
                <fo:inline font-size="14pt" font-weight="bold">Notification d'annulation d'audience</fo:inline>
                <fo:block>
                                      ...
                                      <fo:block>
                                        ...
                                        <fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
                                          ...
                                          <fo:table-body>
                                            ...
                                            <fo:table-row>
                                              <fo:table-cell width="160pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                                <fo:block>
                                                  <fo:inline font-size="12pt" font-weight="normal">Problème :</fo:inline>
                                                </fo:block>
                                              </fo:table-cell>
                                              <fo:table-cell padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                                <fo:block>
                                        ...
                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                          <fo:block text-align="justify">
                                            ...
                                            <fo:inline font-size="12pt">L'appelant précité a déposé une demande d'audience concernant la décision de refuser, de réduire ou d'arrêter les prestations en raison des problèmes précités. Avant le déroulement de l'audience, l'appelant a demandé que l'appel soit retiré.</fo:inline>
                                            <fo:block>
                                              <fo:leader leader-pattern="space" />
                                            </fo:block>
                                            <fo:block>
                                            ...
                                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt" text-align="left">
                                              <fo:block>
                                                <fo:inline font-size="12pt">Suite à l'examen de l'ensemble des informations collectées disponibles concernant l'appel, la requête visant à retirer l'appel a été accordée.</fo:inline>
                                                <fo:block>
                                                  <fo:leader leader-pattern="space" />
                                                </fo:block>
                                                <fo:block>
