...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  ...
  <xsl:template match="DATA">
    ...
    <xsl:apply-templates select="STRUCT[SNAME='AppealedCaseRejectionNoticeData']" />
  </xsl:template>
          ...
          <fo:block>
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              <fo:block text-align="center">
                <fo:inline font-size="14pt" font-weight="bold">Notification de rejet d'un dossier en appel</fo:inline>
                <fo:block>
                                      ...
                                      <fo:block>
                                          ...
                                          <fo:table-body>
                                            <fo:table-row>
                                              <fo:table-cell width="160pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                                <fo:block>
                                                  <fo:inline font-size="12pt" font-weight="normal">Numéro de l'appel :</fo:inline>
                                                </fo:block>
                                              </fo:table-cell>
                                            ...
                                            <fo:table-row>
                                              <fo:table-cell width="160pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                                <fo:block>
                                                  <fo:inline font-size="12pt" font-weight="normal">Numéro du dossier avant l'appel :</fo:inline>
                                                </fo:block>
                                              </fo:table-cell>
                                              <fo:table-cell padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="black">
                                                <fo:block>
                                                  <fo:inline font-size="12pt" font-weight="normal">
                                                    <xsl:apply-templates select="FIELD[FNAME='priorAppealCaseReference']" />
                                                  </fo:inline>
                                                </fo:block>
                                              </fo:table-cell>
                                            </fo:table-row>
                                        ...
                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                          <fo:block>
                                            ...
                                            <fo:inline font-size="12pt" font-weight="normal">Chère Madame, cher Monsieur,</fo:inline>
                                            <fo:block>
                                              <fo:leader leader-pattern="space" />
                                            </fo:block>
                                            <fo:block>
                                            ...
                                            <fo:inline font-size="12pt">Vous avez déposé une demande d'audience concernant la décision de refuser, de réduire ou d'arrêter les prestations en raison des problèmes précités. Après examen de l'ensemble des informations collectées disponibles concernant cet appel, la requête visant à organiser une audience à propos de cette décision a été rejetée pour le motif ci-dessous :</fo:inline>
                                            <fo:block>
                                              <fo:leader leader-pattern="space" />
                                            </fo:block>
                                            <fo:block>
                                            ...
                                            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                              <fo:block>
                                                ...
                                                <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                  <fo:block>
                                                    <fo:inline font-size="12pt">
                                                      Cette décision deviendra définitive, sauf si sous <xsl:apply-templates select="FIELD[FNAME='appealTimeLimit']" /> jours suivant la date de la présente lettre, une demande écrite est envoyée à l'adresse ci-après pour demander une nouvelle audience :
                                                    </fo:inline>
                                                    <fo:block>
                                                      <fo:leader leader-pattern="space" />
                                                    </fo:block>
