          ...
          <fo:block>
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              <fo:block text-align="center">
                <fo:inline font-size="14pt" font-weight="bold">Transcription de l'audience</fo:inline>
                <fo:block>
                                      ...
                                      <fo:block>
                                        ...
                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                          <fo:block>
                                            ...
                                            <fo:inline font-size="12pt" font-weight="normal">Veuillez trouver ci-joint une copie de la transcription demandée pour l'audience susmentionnée.</fo:inline>
                                            <fo:block>
                                              <fo:leader leader-pattern="space" />
                                            </fo:block>
                                            <fo:block>
