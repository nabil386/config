        ...
        <fo:flow flow-name="xsl-region-body" font-family="WT Sans">
          ...
          <fo:block text-align="center">
            <fo:inline font-weight="bold">
              <fo:inline xsl:use-attribute-sets="Normal_1">Avis d'audience</fo:inline>
            </fo:inline>
          </fo:block>
          ...
          <fo:block xsl:use-attribute-sets="Normal_2"> </fo:block>
          <fo:block xsl:use-attribute-sets="Normal_2">Si vous avez une raison valable de ne pas comparaître à cette audience, vous devez en rendre compte auprès du responsable de l'audience.</fo:block>
