          ...
          <fo:block>
            <fo:block space-before.optimum="1pt" space-after.optimum="2pt">
              <fo:block text-align="center">
                <fo:inline font-size="14pt" font-weight="bold">Accusé de réception de la demande d'audience et confirmation du statut de l'assistance</fo:inline>
                <fo:block>
                                      ...
                                      <fo:block>
                                        ...
                                        <fo:block space-before.optimum="1pt" space-after.optimum="2pt" white-space-collapse="false" linefeed-treatment="preserve" white-space-treatment="preserve">
                                          <fo:block text-align="left">
                                            ...
                                            <fo:inline font-size="12pt">
                                              Nous vous informons qu'une demande d'audience a été reçue de la part de <xsl:apply-templates select="FIELD[FNAME='appellantName']" /> concernant les problèmes répertoriés ci-après.
                                            </fo:inline>
                                            <fo:block>
                                              <fo:leader leader-pattern="space" />
                                            </fo:block>
