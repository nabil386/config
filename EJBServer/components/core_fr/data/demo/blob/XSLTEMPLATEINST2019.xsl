...
<!-- BEGIN, CR00352142, PB -->
          ...
          <!-- Main body -->
          <fo:block xsl:use-attribute-sets="Normal_1">
            Nous souhaitons vous informer que vous êtes inscrit en tant que groupe externe auprès de notre agence sous la référence No.
            ...
            à compter du <xsl:apply-templates select="./FIELD[FNAME='externalPartyDtls']/STRUCT[SNAME='ConcernNameAlternateIDRegDate']/FIELD[FNAME='registrationDate']" />.
          </fo:block>
          <fo:block linefeed-treatment="preserve" font-size="12.0pt" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">&nbsp;</fo:block>
          <!-- Closing block -->
          <fo:block xsl:use-attribute-sets="Normal_1">Cordialement,</fo:block>
          <fo:block linefeed-treatment="preserve" font-size="12.0pt" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">&nbsp;</fo:block>
          <fo:block xsl:use-attribute-sets="Normal_1">
