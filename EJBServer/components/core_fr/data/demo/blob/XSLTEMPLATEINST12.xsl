...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
      ...
      <fo:page-sequence master-reference="only">
        ...
        <fo:flow flow-name="xsl-region-body">
          ...
          <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
            <fo:inline xsl:use-attribute-sets="Normal_1">Merci de noter que les droits affichés sont uniquement des estimations basées sur les informations que vous nous avez fournies aujourd'hui.  Les droits réels peuvent uniquement être déterminés à réception d'une réclamation/demande effectuée à l'aide du formulaire de demande/réclamation adéquat.</fo:inline>
          </fo:block>
  ...
  <xsl:template match="STRUCT[SNAME='IncomeSupportDetails']">
    ...
    <fo:block xsl:use-attribute-sets="Normal_1" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="center" text-indent="0.0pt">
      <fo:inline xsl:use-attribute-sets="Normal_2">Récapitulatif de l'ensemble des droits ESTIMES pour <xsl:apply-templates select="FIELD[FNAME='applicantTitle']"/>&nbsp;<xsl:apply-templates select="FIELD[FNAME='applicantFirstName']"/>&nbsp;<xsl:apply-templates select="FIELD[FNAME='applicantSurname']"/></fo:inline>
    </fo:block>
  ...
  <xsl:template match="STRUCT[SNAME='EligibilityDocumentData']">
    ...
    <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline xsl:use-attribute-sets="Normal_1">En fonction des informations que vous nous avez fournies aujourd'hui, la liste suivante indique les membres du ménage et les prestations auxquelles ils ont potentiellement droit.</fo:inline>
    </fo:block>
          ...
          <fo:table-body>
            <fo:table-row>
              <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" border-left-style="solid" border-left-width="0.5pt" border-right-style="solid" border-right-width="0.5pt" border-top-style="solid" border-top-width="0.5pt" padding-left="5.4pt" padding-right="5.4pt">
                <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
                  <fo:inline xsl:use-attribute-sets="Normal_3">Potentiellement éligible pour :</fo:inline>
                </fo:block>
              </fo:table-cell>
              <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" border-left-style="solid" border-left-width="0.5pt" border-right-style="solid" border-right-width="0.5pt" border-top-style="solid" border-top-width="0.5pt" padding-left="5.4pt" padding-right="5.4pt">
                <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
                  <fo:inline xsl:use-attribute-sets="Normal_3">Membres du ménage :</fo:inline>
                </fo:block>
              </fo:table-cell>
            </fo:table-row>
            ...
            <fo:table-row>
              <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" border-left-style="solid" border-left-width="0.5pt" border-right-style="solid" border-right-width="0.5pt" border-top-style="solid" border-top-width="0.5pt" padding-left="5.4pt" padding-right="5.4pt">
                <fo:block margin-left="108.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="-108.0pt">
                  <fo:inline xsl:use-attribute-sets="Normal_3">Autres groupes d'aide financière en espèces potentiellement éligibles du ménage :</fo:inline>
                </fo:block>
              </fo:table-cell>
            </fo:table-row>
        ...
        <fo:table>
          ...
          <fo:table-body>
            <fo:table-row>
              <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" border-left-style="solid" border-left-width="0.5pt" border-right-style="solid" border-right-width="0.5pt" border-top-style="solid" border-top-width="0.5pt" padding-left="5.4pt" padding-right="5.4pt">
                <fo:block margin-left="108.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="-108.0pt">
                  <fo:inline xsl:use-attribute-sets="Normal_3">Non éligible pour :</fo:inline>
                </fo:block>
              </fo:table-cell>
            </fo:table-row>
