    ...
    <fo:root>
      ...
      <fo:page-sequence master-reference="only">
        ...
        <!-- END NON-TRANSLATABLE -->
          ...
          <fo:block xsl:use-attribute-sets="Normal_3">&nbsp;</fo:block>
          <fo:block xsl:use-attribute-sets="Normal_6">
            Ce contrat est un accord entre le client
            <xsl:apply-templates select="FIELD[FNAME='concernRoleName']" />
            et
            <xsl:apply-templates select="FIELD[FNAME='organisationName']" />.
            Le client s'engage à effectuer les tâches suivantes en retour
            des prestations au titre de son dossier intégré avec l'ID
            ...
            <fo:table-body>
              <fo:table-row line-height="5mm">
                <fo:table-cell column-number="1">
                  <fo:block xsl:use-attribute-sets="Normal_7">ID de tâche</fo:block>
                </fo:table-cell>
                <fo:table-cell column-number="2">
                  <fo:block xsl:use-attribute-sets="Normal_8">Description des tâches</fo:block>
                </fo:table-cell>
                <fo:table-cell column-number="3">
                  <fo:block xsl:use-attribute-sets="Normal_8">Date d'échéance</fo:block>
                </fo:table-cell>
              </fo:table-row>
          ...
          <fo:block xsl:use-attribute-sets="Normal_3">&nbsp;</fo:block>
          <fo:block xsl:use-attribute-sets="Normal_6">Cordialement,</fo:block>
          <fo:block xsl:use-attribute-sets="Normal_3">&nbsp;</fo:block>
          <fo:block xsl:use-attribute-sets="Normal_6">
            <xsl:apply-templates select="FIELD[FNAME='userFullName']" />
          </fo:block>
