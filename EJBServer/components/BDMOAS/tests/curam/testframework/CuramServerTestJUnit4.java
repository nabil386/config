 ...
 */
public abstract class CuramServerTestJUnit4 {
   ...
   * by this test class.
   */
  private static String kLocaleForTransaction;

  /**
   * Constructor for CuramsServerTestJUnit4
   */
  public CuramServerTestJUnit4() {
  ...
  protected void clearCaches() {
    ...
    try {
      ...
      Assert.fail("CodeTables failed to reload" + e.toString());
  ...
  protected final void begin() {
    ...
    // BEGIN, CR00479599, BD
    final TransactionInfo ti = // END, CR00479599,
