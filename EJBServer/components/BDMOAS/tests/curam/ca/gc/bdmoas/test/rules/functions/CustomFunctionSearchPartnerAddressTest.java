...
import curam.rules.functions.CustomFunctionSearchPartnerAddress;
...
/**
 * The Class tests {@link CustomFunctionSearchPartnerAddress} custom
 * function.
 */

@RunWith(JMockit.class)
public class CustomFunctionSearchPartnerAddressTest
  ...
  @Tested
  CustomFunctionSearchPartnerAddress customFunction;

  public CustomFunctionSearchPartnerAddressTest() {
  ...
  public void before() throws NoSuchSchemaException {
    ...
    customFunction = new CustomFunctionSearchPartnerAddress();
  ...
  public void test_valid()
    ...
    final Entity resiSrchCritEntity =
      datastore.newEntity(BDMOASDatastoreConstants.kSearchCriteriaResi);
    resiSrchCritEntity.setAttribute(BDMOASDatastoreConstants.kResidCountry,
      COUNTRY.CA);
    resiSrchCritEntity.setAttribute(BDMOASDatastoreConstants.kResidPostalCode,
      "B1B1B1");
    personEntity.addChildEntity(resiSrchCritEntity);
    ...
    final Entity verifyPartnerPersonEntity =
      applicationEntity.getChildEntities(
        datastore.getEntityType(BDMDatastoreConstants.PERSON))[0];
    final Entity[] searchAddress = verifyPartnerPersonEntity.getChildEntities(
