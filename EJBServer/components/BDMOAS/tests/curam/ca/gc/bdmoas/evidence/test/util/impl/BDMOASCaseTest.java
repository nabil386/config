...
public class BDMOASCaseTest extends CuramServerTestJUnit4 {
  ...
  public PersonRegistrationResult registerPerson()
    ...
    personDtls.personRegistrationDetails.firstForename = "Test";
    personDtls.personRegistrationDetails.surname = "Person";
    ...
    personDtls.personRegistrationDetails.addressIndicator = Boolean.TRUE;
    personDtls.personRegistrationDetails.birthCountry = COUNTRY.CA;
  ...
  public String getAddressData() throws AppException, InformationalException {
    ...
    addressDtls.addressLine1 = "40 10th Street";
