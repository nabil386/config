...
public class BDMOASIntakeApplicationMappingEventsTest
  ...
  Entity partnerPersonEntity;

  Entity communicationPrefEntity;

  Entity legalStatusEntity;

  Entity residentialAddressEntity;
  ...
  public void setUpEntities(final long concernRoleID)
    ...
    residentialAddressEntity.setAttribute(BDMDatastoreConstants.SUITE_NUM,
      "22");
    residentialAddressEntity.setAttribute(BDMDatastoreConstants.CITY,
      "Cityhere");
    residentialAddressEntity.setAttribute(BDMDatastoreConstants.STATE,
      "Florida");
    residentialAddressEntity
      .setAttribute(BDMDatastoreConstants.ADDRESS_COUNTRY, COUNTRY.US);
    residentialAddressEntity.setAttribute(BDMDatastoreConstants.ADDRESS_LINE1,
      "40");
    residentialAddressEntity.setAttribute(BDMDatastoreConstants.ADDRESS_LINE2,
      "imaginary road");
    residentialAddressEntity.setAttribute(BDMDatastoreConstants.ZIP_CODE,
      "12345");
    personEntity.addChildEntity(residentialAddressEntity);
    residentialAddressEntity.update();

    personEntity.update();

    partnerPersonEntity = datastore.newEntity(BDMDatastoreConstants.PERSON);
    partnerPersonEntity
      .setAttribute(BDMDatastoreConstants.IS_PRIMARY_PARTICIPANT, "false");
    partnerPersonEntity.setAttribute(
   ...
   */
  @Test
  public void test_preCreateCasesInCuram_Primary()
