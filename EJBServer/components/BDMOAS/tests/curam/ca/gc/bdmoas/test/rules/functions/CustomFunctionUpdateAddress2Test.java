...
import curam.rules.functions.CustomFunctionUpdateAddress2;
...
/**
 * The Class tests {@link CustomFunctionUpdateAddress2} custom
 * function.
 */

@RunWith(JMockit.class)
public class CustomFunctionUpdateAddress2Test
  ...
  @Tested
  CustomFunctionUpdateAddress2 customFunction;

  public CustomFunctionUpdateAddress2Test() {
  ...
  public void before() throws NoSuchSchemaException {
    ...
    customFunction = new CustomFunctionUpdateAddress2();
   ...
   */
  @Test
  public void test_valid_residental()
  ...
  public void test_valid_mailing()
    ...
    intlMailingEntity.setAttribute(BDMDatastoreConstants.ADDRESS_COUNTRY,
      "US");
    personEntity.addChildEntity(intlMailingEntity);
    ...
    searchEntityMailing.setAttribute(BDMDatastoreConstants.ADDRESS_DATA1,
      addressData);
    personEntity.addChildEntity(searchEntityMailing);
    ...
    final Entity verifyPersonEntity = applicationEntity.getChildEntities(
      datastore.getEntityType(BDMDatastoreConstants.PERSON))[0];
    final Entity mailingAddress = verifyPersonEntity.getChildEntities(
