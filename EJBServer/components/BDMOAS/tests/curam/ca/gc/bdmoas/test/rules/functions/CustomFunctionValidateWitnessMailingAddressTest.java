...
import curam.rules.functions.CustomFunctionValidateWitnessMailingAddress;
...
/**
 * The Class tests {@link CustomFunctionValidateWitnessMailingAddress} custom
 * function.
 */

@RunWith(JMockit.class)
public class CustomFunctionValidateWitnessMailingAddressTest
  ...
  @Tested
  CustomFunctionValidateWitnessMailingAddress customFunction;

  public CustomFunctionValidateWitnessMailingAddressTest() {
  ...
  public void before() throws NoSuchSchemaException {
    ...
    customFunction = new CustomFunctionValidateWitnessMailingAddress();
  ...
  public void test_valid_idmatch()
    ...
    witnessEntity.setTypedAttribute(BDMDatastoreConstants.WS_MAIL_CONTINUE,
      "1234");
  ...
  public void test_valid_address_check()
    ...
    assertEquals(mailingAddress.getAttribute("validateStatus"), "1");
