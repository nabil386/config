 ...
 * @curam.exclude
 */
public class CustomFunctionSearchWitnessAddress extends BDMFunctor {
   ...
   */
  public CustomFunctionSearchWitnessAddress() {
  ...
  public Adaptor getAdaptorValue(final RulesParameters rulesParameters)
    ...
    if (!StringUtil.isNullOrEmpty(postalCode)
      ...
      setAddressSearchData(datastore, declarationEntity,
