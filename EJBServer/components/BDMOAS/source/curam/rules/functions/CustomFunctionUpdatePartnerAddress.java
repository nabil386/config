 ...
 * @curam.exclude
 */
public class CustomFunctionUpdatePartnerAddress
   ...
   */
  public CustomFunctionUpdatePartnerAddress() {
  ...
  public Adaptor getAdaptorValue(final RulesParameters rulesParameters)
    ...
    addAddressDetails(applicationEntity, datastore, personEntity_Partner,
      addressType, step);
