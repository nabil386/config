 ...
 * @curam.exclude
 */
public class CustomFunctionSearchPartnerAddress
   ...
   */
  public CustomFunctionSearchPartnerAddress() {
  ...
  public Adaptor getAdaptorValue(final RulesParameters rulesParameters)
    ...
    final String addressType = getOptionalStringParam(rulesParameters, 1);
    ...
    if (!StringUtil.isNullOrEmpty(postalCode)
      ...
      setAddressSearchData(datastore, personEntity_Partner,
  ...
  private void setAddressSearchData(final Datastore datastore,
    ...
    searchAddressEntity.setAttribute(BDMDatastoreConstants.IS_ACTIVE,
      IEGYESNO.YES); // Set Address to Active
    searchAddressEntity.setAttribute(
      BDMDatastoreConstants.FORMATTED_ADDRESS_DATA, BDMOASConstants.kAddNew);
