...
/**
 * Contains a custom function that will validate the ‘Last Name' of partner
 * information details.
 */

public class CustomFunctionValidatePartnerLastName extends CustomFunctor {

  /**
   * Custom function to validate last name.
   * Validation Rule: "Last name must be entered when First name, Date of Birth
