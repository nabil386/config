...
public class BDMOASMaritalRelationshipMenuStateLoader
  implements DynamicMenuStateLoader {

  private static final String EVIDENCE_ID = "evidenceID";

  private static final String LIVING_APART_FOR_REASONS_BEYOND_CONTROL =
    "CreateChildOASDET0011";
  ...
  private void maintainMenuForApplicationCase(final MenuState menu,
    ...
    for (final String id : idsToUpdate) {
      if (!id.equals(LIVING_APART_FOR_REASONS_BEYOND_CONTROL)) {
  ...
  private void maintainMenuForIntegratedCase(final MenuState menu,
    ...
    readEvidenceKey.evidenceType = CASEEVIDENCE.OAS_MARITAL_RELATIONSHIP;
    ...
    if (BDMOASBENEFITTYPE.ALLOWANCE.equals(benefitType)) {
      menu.setVisible(false, LIVING_APART_FOR_REASONS_BEYOND_CONTROL);
    }
