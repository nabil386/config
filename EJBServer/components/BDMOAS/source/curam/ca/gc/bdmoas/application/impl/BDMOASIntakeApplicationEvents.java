  ...
  private void createTasks(final IntakeApplication intakeApplication,
    ...
    if (appCaseID != BDMConstants.kZeroLongValue) {
      if (intakeScriptID.equals(
        ...
        // BEGIN - 111964
        // Note:Removing this as Residence Period evidence
        // has issue configuration to deal with missing data.
        /**
        ...
        final boolean isSpouseOrCLPAddedOnCaseInd = this
          .isSpouseOrCLPAddedOnCase(this.applicationCaseDAO.get(appCaseID));
