...
public class BDMOASApplicationDetailsNavStateLoader
  implements DynamicNavStateLoader {

  private static final String EVIDENCE_ID_PARAM = "evidenceID";

  private static final String BENEFIT_CANCELLATION_NAV_ID =
    "RelatedEvidenceOASDET0007";

  private static final String BENEFIT_CESSATION_NAV_ID =
    "RelatedEvidenceOASDET0008";

  private static final String DEEMED_DATE_NAV_ID =
    "RelatedEvidenceOASDET0009";

  private static final Map<String, String> EVIDENCE_TYPE_NAV_ID_MAP =
    new HashMap<>();

  static {
    EVIDENCE_TYPE_NAV_ID_MAP.put(CASEEVIDENCE.OAS_BENEFIT_CANCELLATION,
      BENEFIT_CANCELLATION_NAV_ID);
    EVIDENCE_TYPE_NAV_ID_MAP.put(CASEEVIDENCE.OAS_BENEFIT_CESSATION,
      BENEFIT_CESSATION_NAV_ID);
    EVIDENCE_TYPE_NAV_ID_MAP.put(CASEEVIDENCE.OAS_DEEMED_DATE,
      DEEMED_DATE_NAV_ID);
  }
