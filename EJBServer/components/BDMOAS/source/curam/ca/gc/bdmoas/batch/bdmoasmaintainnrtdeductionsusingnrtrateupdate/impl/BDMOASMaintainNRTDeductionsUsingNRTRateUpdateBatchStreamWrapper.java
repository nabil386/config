 ...
 * BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatchStream.
 */
public class BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatchStreamWrapper
  implements BatchStream {

  private final curam.ca.gc.bdmoas.batch.bdmoasmaintainnrtdeductionsusingnrtrateupdate.intf.BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatchStream streamObj;
   ...
   * BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatchStream
   */
  public BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatchStreamWrapper(
    final curam.ca.gc.bdmoas.batch.bdmoasmaintainnrtdeductionsusingnrtrateupdate.intf.BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatchStream stream) {
