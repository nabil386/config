 ...
 * the reporting for the BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatch
 * batch program.
 */
public class BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatchWrapper
  implements BatchMain {

  private final BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatch chunkerObj;

  /**
   * Public Constructor
   *
   * @param chunker - This holds the instance of
   * BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatch
   */
  public BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatchWrapper(
    final BDMOASMaintainNRTDeductionsUsingNRTRateUpdateBatch chunker) {
