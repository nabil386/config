...
/**
 * A data type for a gregorian date that recurs, specifically a day of the year
 * such as the third of May. Arbitrary recurring dates are not supported by this
 * datatype. The value space of gMonthDay is the set of calendar dates, as
 * defined in Section 3 of [ISO 8601]. Specifically, it is a set of one-day
 * long, annually periodic instances.
 *
 * <p>
