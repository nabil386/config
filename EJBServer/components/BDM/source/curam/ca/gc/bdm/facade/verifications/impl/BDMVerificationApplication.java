...
public class BDMVerificationApplication extends
  ...
  public BDMCaseEvidenceVerificationDisplayDetailsList
    ...
    for (final CaseEvidenceVerificationDisplayDetails caseEvdVeriDisplayDetails : caseEvidenceVerificationDisplayDetailsList.dtls) {
      ...
      if (caseEvdVeriDisplayDetails.verificationID == 0L) {
         ...
         * getVerificationIDForParticipantVerificationByVdiedLinkID(
         * caseEvdVeriDisplayDetails.concernRoleID,
         * caseEvdVeriDisplayDetails.vDIEDLinkID,
         * caseEvdVeriDisplayDetails.evidenceDescriptorID);
         */
        final VDIEDLinkKey vdiedLinkKey = new VDIEDLinkKey();
  ...
  public BDMUserProvidedVerificationItemKey newUserProvidedVerificationItem(
    ...
    // check for attachment file extension and attachment size
    // TASK 94274 commenting attachemnt validation
    ...
    if (bdmUserProvidedVerificationItemKey.verificationAtachmentLinkID == 0
      ...
      try {
        ...
        for (final VerificationItemUtilizationDtls verificationItemUtilizationUsageDetails : verificationItemUtilizationDtlsSet) {
          ...
          /*
           * for (final VerificationItemProvidedDtls viItemProvidedDtls :
  ...
  public BDMReadVerificationDetails
    ...
    // bdmReadVerificationDetails.readVerificationDetails//
    // .assign(readVerificationDetails.readVerificationDetails);
  ...
  public void validateVerificationItemDetails(
    ...
    // &&
    // details.newUserProvidedVerificationItemDetails.createVerificationAttachmentLinkDetails.createAttachmentDtls.attachmentName
    // .isEmpty()) {
  ...
  public
    ...
    createVerificationAttachment(
      ...
      throws AppException, InformationalException {
    // check for attachment file extension and attachment size
    // validateAttachment(inputDetails.createVerificationAttachmentDetails.details.createAttachmentDtls);
  ...
  // validate attachment file extension and attachment file size
  private void validateAttachment(final AttachmentDtls details)
    ...
    final long attachmentMaxSize = Integer
      .valueOf(Configuration.getProperty(EnvVars.BDM_ENV_UPLOAD_FILE_SIZE))
      * FileUtils.ONE_MB;
    final int attachmentSize = details.attachmentContents.length();
    if (attachmentSize > attachmentMaxSize) {
      throw new AppException(
        BDMENTVERIFICATION.ERR_VERIFICATION_VALID_ATTACHMENT_SIZE);
    }
  }
