...
public class BDMApplicationModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    // START Remove Sample Benefit Intake Program Application Events.
    /**
     * Bind in the Intake Program Application Events.
     */
    // final
    // Multibinder<IntakeProgramApplication.IntakeProgramApplicationEvents>
    // intakeProgramApplicationEventListeners =
    // Multibinder.newSetBinder(binder(),
    // new
    // TypeLiteral<IntakeProgramApplication.IntakeProgramApplicationEvents>() {
    // /**/
    // });
    // intakeProgramApplicationEventListeners.addBinding()
    // .to(BDMIntakeProgramApplicationEventsListener.class);
    // END Remove Sample Benefit Intake Program Application Events.
