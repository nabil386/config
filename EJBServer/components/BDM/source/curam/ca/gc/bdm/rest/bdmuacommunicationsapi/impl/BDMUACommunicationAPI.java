...
import curam.ca.gc.bdm.facade.communication.impl.BDMCommunication;
...
import curam.ca.gc.bdm.rest.bdmuacommunicationsapi.struct.BDMUACommunicationAttachmentKey;
import curam.ca.gc.bdm.rest.bdmuacommunicationsapi.struct.BDMUACommunicationDetails;
...
import curam.citizenworkspace.rest.facade.struct.UAAttachment;
...
public class BDMUACommunicationAPI extends
  ...
  @Override
  public BDMUACommunicationDetails
    getCommunication(final UACommunicationKey uaCommunicationKey)
      throws AppException, InformationalException {

    final BDMUACommunicationDetails bdmUACommunicationDetails =
      new BDMUACommunicationDetails();
    ...
    concernRoleCommunicationKey.communicationID =
      uaCommunicationKey.communication_id;
    final ConcernRoleCommunicationDtls commDtls =
      CommObj.read(concernRoleCommunicationKey);

    bdmUACommunicationDetails.dtls.communication_id =
      commDtls.communicationID;
    bdmUACommunicationDetails.dtls.subjectText = commDtls.subjectText;
    bdmUACommunicationDetails.dtls.communicationDate =
      commDtls.communicationDate;
    ...
    bdmUACommunicationDetails.trackingNumber =
      Long.toString(bdmCommDtls.trackingNumber);

    return bdmUACommunicationDetails;
  }
  ...
  /**
   * Bug: 122434 Added this API to download correspondences via CCT on UA.
   */
  @Override
  public UAAttachment downloadCommunicationAttachment(
    final BDMUACommunicationAttachmentKey commAttachmentKey)
    throws AppException, InformationalException {
    ...
    communicationIDKey.communicationID = commAttachmentKey.communicationID;
    final BDMFileNameAndDataDtls bdmFileNameAndDataDtls =
      bdmCommunication.printCommunication(communicationIDKey);
    final UAAttachment uaAttachment = new UAAttachment();
    uaAttachment.fileName = bdmFileNameAndDataDtls.fileName;
    uaAttachment.data = bdmFileNameAndDataDtls.fileContent;
