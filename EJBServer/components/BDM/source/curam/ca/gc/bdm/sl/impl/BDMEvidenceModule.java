...
public class BDMEvidenceModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    // The BDMEvidenceControllerHookExtension mechanism is an extension of the
    // evidence controller hook, with this extension, common cases such as
    // Participant Data case and Application Case don't need another binding in
    // the components such as BDMOAS, BDMOAS component specific hook
    // class is BDMOASEvidenceControllerHookExtensionImpl
    bind(BDMEvidenceControllerHookExtensionIntf.class)
      .to(BDMEvidenceControllerHookExtensionImpl.class);

    evidenceControllerMapBinder.addBinding(CASETYPECODE.APPLICATION_CASE)
      .toInstance(FactoryMethodHelper
        .getNewInstanceMethod(BDMEvidenceControllerHookFactory.class));
  }
