...
public class BDMMaintainForeignEngagementCase
  ...
  String readFAListLinkedToAttachmentString(final BDMFAList list) {

    String faListLinkedToAttachmentStr = "";
    if (list != null) {

      for (int i = 0; i < list.bdmFADetails.size(); i++) {
        if (faListLinkedToAttachmentStr.isEmpty()) {
          faListLinkedToAttachmentStr +=
            list.bdmFADetails.get(i).fApplicationID;
        } else {
          faListLinkedToAttachmentStr +=
            list.bdmFADetails.get(i).fApplicationID
    ...
    return faListLinkedToAttachmentStr;
  }
