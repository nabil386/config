...
public class BDMGenerateCorrespondenceMapper {
  ...
  public static AddressType getAddress(final java.lang.String addressLineOne,
  ...
  public static XMLGregorianCalendar
    getXMLDate(final curam.util.type.Date conDate)
  ...
  public java.lang.String addressUpdateMapper(
    final BDMCorrespondenceDetails bdmCorrespondenceDetails)
    throws javax.xml.bind.JAXBException, AppException,
    InformationalException {
    ...
    try {
      ...
      if (CuramConst.gkZero != bdmCorrespondenceDetails.ccThirdPartyContactConcernRoleID) {
   ...
   * @return Date
   */
  public static Date getNullDateForCCT() {
