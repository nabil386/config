...
public class BDMConcernRoleMappingStrategyImpl
   ...
   * @throws AppException
   */
  protected void addDemographicInformationForProspectPerson(
   ...
   * @throws AppException
   */
  protected void addDemographicInformationForPerson(final Entity personEntity,
                                                  final ConcernRole concernRole)
          throws AppException, InformationalException {
   ...
   * @throws AppException
   */
  protected void updatePersonPaymentMethod(final Entity personEntity,
                                         final ConcernRole concernRole)
          throws AppException, InformationalException {
   ...
   * @throws InformationalException
   */
  protected boolean isRegisteredPerson(final ConcernRole concernRole)
          throws AppException, InformationalException {
   ...
   */
  protected boolean isPrimaryParticipant(final Entity personEntity,
                                       final ConcernRole concernRole) {
   ...
   * @throws InformationalException
   */
  protected void linkExternalUserToConcernRole(final Entity personEntity,
                                             final ConcernRole concernRole)
          throws AppException, InformationalException {
   ...
   * @param concernRole
   */
  protected void processPaymentEvd(final Entity personEntity,
