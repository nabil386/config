...
public class BDMStartIntakeEventsListener implements StartIntakeEvents {
   ...
   * OOTB exception
   */
  private void prePopulateDetails(final Entity rootEntity)
   ...
   * @throws InformationalException
   */
  private void setPersonEntityAttributes(
   ...
   * OOTB exception
   */
  private void populateDECDDetails(final String userName,
   ...
   * @throws InformationalException
   */
  private void setBankEntityAttributes(
