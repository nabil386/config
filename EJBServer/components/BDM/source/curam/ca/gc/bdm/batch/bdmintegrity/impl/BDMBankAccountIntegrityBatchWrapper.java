...
public class BDMBankAccountIntegrityBatchWrapper implements BatchMain {

  private final BDMBankAccountIntegrityBatch bdmBankAccountIntegrityBatch;

  public BDMBankAccountIntegrityBatchWrapper(
    final BDMBankAccountIntegrityBatch bdmBankAccountIntegrityBatch) {

    this.bdmBankAccountIntegrityBatch = bdmBankAccountIntegrityBatch;
  }
  ...
  public void sendBatchReport(final String instanceID,
    ...
    bdmBankAccountIntegrityBatch.sendBatchReport(instanceID, batchProcessDtls,
