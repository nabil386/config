 ...
 * @altered 1.2 - 01st March 2022 by Siva @ 12319 Task Build Flag icon into case
 * context panel Added new override method for
 * readContextPanelDetails() for display for UrgentFlag icon .
 *
 */

class BDMApplicationCaseContextPanelHelperImpl {
  ...
  public BDMApplicationCaseContextPanelHelperImpl() {
  ...
  public ContentPanelBuilder
    ...
    applicationCaseDetails.addSingleListItem(
      this.getApplicationDetailsList(applicationCase),
      "applicationcase-details");

    final List<IntakeProgramApplication> appliedProgramsList =
      new ArrayList();

    final Iterator var5 = applicationCase.getPrograms().iterator();
    final Set<String> programNameSet = new HashSet<String>();

    while (var5.hasNext()) {
      final IntakeProgramApplication program =
        (IntakeProgramApplication) var5.next();
  ...
  protected String
    ...
    final Iterator var4 = programList.iterator();
    while (var4.hasNext()) {
      final IntakeProgramApplication program =
        (IntakeProgramApplication) var4.next();
