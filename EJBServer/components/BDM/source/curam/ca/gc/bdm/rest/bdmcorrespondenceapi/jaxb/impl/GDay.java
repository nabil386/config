...
/**
 * A data type for a gregorian day that recurs, specifically a day of the month
 * such as the 5th of the month. Arbitrary recurring days are not supported by
 * this datatype. The value space of gDay is the space of a set of calendar
 * dates as defined in Section 3 of [ISO 8601]. Specifically, it is a set of
