...
public class BDMDateUtil {
  ...
  public static Date getStartOfNextMonth(final Date date) {
   ...
   * @return
   */
  public static Boolean isFirstOfMonth(final Date date) {

    final Calendar calendar = date.getCalendar();

    return calendar.getActualMinimum(Calendar.DAY_OF_MONTH) == calendar
