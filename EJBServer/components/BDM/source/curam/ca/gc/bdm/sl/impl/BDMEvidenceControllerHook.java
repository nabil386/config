...
public class BDMEvidenceControllerHook
  ...
  // BEGIN 95630 DEV: Implement Manage Override Evidence - R2
  @Inject
  BDMEvidenceControllerHookExtensionIntf evidenceControllerHookExtension;
  // END 95630 DEV: Implement Manage Override Evidence - R2
  ...
  public void preRemoveEvidence(final CaseKey caseKey,
    ...
    // BEGIN 95630 DEV: Implement Manage Override Evidence - R2
    evidenceControllerHookExtension.preRemoveEvidence(caseKey, evidenceKey);
    // END 95630 DEV: Implement Manage Override Evidence - R2
  ...
  public void postInsertEvidence(final CaseKey caseKey,
    ...
    // BEGIN 95630 DEV: Implement Manage Override Evidence - R2
    evidenceControllerHookExtension.postInsertEvidence(caseKey, evidenceKey);
    // END 95630 DEV: Implement Manage Override Evidence - R2
  ...
  private void enactFRPTaskWorkFlow(final CaseKey caseKey,
    ...
    // BEGIN BUG 98492: Fix for Evidence Task
    final LocalisableString localString = new LocalisableString(
      BDMBPOTASKMANAGEMENT.INF_EVIDENCE_CREATION_APPROVAL_TASK_MSG);
    localString.arg(oralWrittenLanguage);
    localString.arg(evidenceTypeDesc);
    localString.arg(fecTypeDesc);
    localString.arg(caseHeaderDtls.caseReference);
    // END BUG 98492: Fix for Evidence Task

    bfmFECTaskCrtDetails.subject =
      localString.getMessage(TransactionInfo.getProgramLocale());
  ...
  private void enactFCPTaskWorkFlow(final CaseKey caseKey,
    ...
    taskSubject.append("Evidence of type" + CuramConst.gkSpace
      + evidenceTypeDesc + CuramConst.gkSpace + fecTypeDesc
      + CuramConst.gkSpace + caseHeaderDtls.caseReference + CuramConst.gkSpace
      + "requires Approval");

    bfmFECTaskCrtDetails.subject = taskSubject.toString();
  ...
  public void postModifyEvidence(final CaseKey caseKey,
    ...
    // BEGIN 95630 DEV: Implement Manage Override Evidence - R2
    evidenceControllerHookExtension.postModifyEvidence(caseKey, evidenceKey);
    // END 95630 DEV: Implement Manage Override Evidence - R2
  ...
  public void postRemoveEvidence(final CaseKey caseKey,
    ...
    // BEGIN 95630 DEV: Implement Manage Override Evidence - R2
    evidenceControllerHookExtension.postRemoveEvidence(caseKey, evKey);
    // END 95630 DEV: Implement Manage Override Evidence - R2
  ...
  public void postDiscardPendingUpdate(
    ...
    super.postDiscardPendingUpdate(paramEvidenceDescriptorKey);
    evidenceControllerHookExtension
      .postDiscardPendingUpdate(paramEvidenceDescriptorKey);
