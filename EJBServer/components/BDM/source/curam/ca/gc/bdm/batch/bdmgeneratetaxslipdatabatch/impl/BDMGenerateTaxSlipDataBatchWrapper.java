...
public class BDMGenerateTaxSlipDataBatchWrapper implements BatchMain {

  private final BDMGenerateTaxSlipDataBatch bdmApplyDeductionsBatch;

  public BDMGenerateTaxSlipDataBatchWrapper(
    final BDMGenerateTaxSlipDataBatch bdmApplyDeductionsBatch) {

    this.bdmApplyDeductionsBatch = bdmApplyDeductionsBatch;
  }
  ...
  public void sendBatchReport(final String instanceID,
    ...
    bdmApplyDeductionsBatch.sendBatchReport(instanceID, batchProcessDtls,
