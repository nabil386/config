...
/**
 * Contains a custom function that will validate if the end date is before
 * start date.
 *
 * @curam.exclude
 */
public class CustomFunctionValidateEndDateNotEarlierThanStartDate
  extends BDMFunctor {
  ...
  public Adaptor getAdaptorValue(final RulesParameters rulesParameters)
    ...
    if (!inputToDate.isZero()) {
      return AdaptorFactory
        .getBooleanAdaptor(!inputToDate.before(inputFromDate));
    }
