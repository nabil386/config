...
/**
 *
 * Area code can only be 3 digits when country code is + 1.
 *
 */
public class CustomFunctionValidatePhoneAreaCode extends CustomFunctor {
  ...
  public Adaptor getAdaptorValue(final RulesParameters rulesParameters)
    ...
    if (null != phoneAreaCodeAdaptor && null != countryCodeAdaptor) {
      ...
      // validation: if country code is +1, then area code is 3
      // digits
