...
/**
 * Contains a custom function that will validate if the living start date is
 * before
 * birth date.
 *
 ...
 * @curam.exclude
 */
public class CustomFunctionvalidateStartedLivingDateBeforeDOB
  extends BDMFunctor {

  /**
   * A custom function that will validate if the dependant started living date
   * before dependant birth
   * date.
   *
  ...
  public Adaptor getAdaptorValue(final RulesParameters rulesParameters)
    ...
    return AdaptorFactory.getBooleanAdaptor(
      dateParameter.after(birthdate) || dateParameter.equals(birthdate));
  }
