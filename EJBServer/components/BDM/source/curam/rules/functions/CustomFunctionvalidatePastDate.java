 ...
 * @curam.exclude
 */
public class CustomFunctionvalidatePastDate extends BDMFunctor {

  /**
   * A custom function that will validate if the provided date is not a past
   * date.
   *
  ...
  public Adaptor getAdaptorValue(final RulesParameters rulesParameters)
    ...
    return AdaptorFactory.getBooleanAdaptor(
      dateParameter.equals(today) || dateParameter.after(today));
  }
