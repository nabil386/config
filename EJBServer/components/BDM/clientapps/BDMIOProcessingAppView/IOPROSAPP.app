...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="IOPROSAPP"
 logo="IOProcessingApp.logo"

 subtitle="IOProcessingApp.subtitle"
 user-message="IOProcessingApp.UserMessage">
  ...
  <ac:section-ref id="IOPROSAPPHOMEWorkspaceSection"/>
	<ac:section-ref id="IOPROSAPPCLIENTCASESWorkspaceSection"/>
	<ac:section-ref id="IOPROSAPPDefaultAppInboxSection"/>
	<ac:section-ref id="IOPROSAPPDefaultAppCalendarSection"/>
