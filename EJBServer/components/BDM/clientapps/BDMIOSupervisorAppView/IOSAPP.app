...
<ac:application xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 id="IOSAPP"
 logo="IOSupervisorApp.logo"
 
 subtitle="IOSupervisorApp.subtitle"
 user-message="IOSupervisorApp.UserMessage">
  ...
  <ac:section-ref id="IOSAPPHomeSection"/>
  <ac:section-ref id="IOSAPPSection"/>
  <ac:section-ref id="IOSAPPDefaultAppInboxSection"/>
  <ac:section-ref id="IOSAPPDefaultAppCalendarSection"/>
