package curam.bdm.test.ca.gc.bdm.evidence.foreignresidenceperiod.impl;
...
/**
 * Test Foreign Residence Period evidence business validations and calculated
 * attribute.
 *
 * 64630 DEV: Implement 387-01 Add Residence based Creditable details to Foreign
 * Engagement Case
 */
public class BDMForeignResidencePeriodTest
  ...
  private static final String ERR_OVERLAPPING_FOREIGN_RESIDENCE_PERIOD =
    "A Residence Period record already exists for an overlapping period.";
  ...
  public void startDateBeforeEndDateValidationFailure()
    ...
    final Exception exception =
      Assert.assertThrows(InformationalException.class, () -> {
        createForeignResidencePeriodEvidence(integratedCaseID,
   ...
   */
  @Test
  public void foreignResidencePeriodOverlapFailure()
    throws AppException, InformationalException {
    ...
    assertTrue(exception.getMessage()
      .contains(ERR_OVERLAPPING_FOREIGN_RESIDENCE_PERIOD));
  }
   ...
   */
  @Test
  public void foreignResidencePeriodOverlapSuccess()
    throws AppException, InformationalException {
   ...
   */
  @Test
  public void foreignResidencePeriodCountryTest()
    throws AppException, InformationalException {
    ...
    final StandardEvidenceInterface standardEvidenceInterface =
      map.getEvidenceType(
        CASEEVIDENCEEntry.BDM_FOREIGN_RESIDENCE_PERIOD.getCode());
