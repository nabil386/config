...
import curam.rules.functions.CustomFunctionvalidateStartDateBeforeDOB;
...
/**
 * The Class tests {@link CustomFunctionvalidateStartDateBeforeDOB} custom
 * function.
 */
@RunWith(JMockit.class)
public class CustomFunctionvalidateStartDateBeforeDOBTest
  ...
  /** The tested class. */
  @Tested
  CustomFunctionvalidateStartDateBeforeDOB customFunction;

  /**
   * Instantiates a new CustomFunctionconcatenateTest.
   */
  public CustomFunctionvalidateStartDateBeforeDOBTest() {
  ...
  public void before() {
    ...
    customFunction = new CustomFunctionvalidateStartDateBeforeDOB();
