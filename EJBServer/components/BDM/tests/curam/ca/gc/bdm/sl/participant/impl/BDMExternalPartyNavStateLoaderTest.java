...
import curam.ca.gc.bdm.sl.tab.externalparty.impl.BDMExternalPartyNavStateLoader;
...
import curam.util.tab.impl.NavigationStateFactory;
...
public class BDMExternalPartyNavStateLoaderTest
  ...
  public BDMExternalPartyNavStateLoaderTest() {
  ...
  public void testloadMenuState()
    ...
    final NavigationState menuState =
      NavigationStateFactory.getNavigationStateInstance();
    ...
    final BDMExternalPartyNavStateLoader personHomeMenuLoader =
      new BDMExternalPartyNavStateLoader();
    personHomeMenuLoader.loadNavState(menuState, pageParameters, idsToUpdate);
