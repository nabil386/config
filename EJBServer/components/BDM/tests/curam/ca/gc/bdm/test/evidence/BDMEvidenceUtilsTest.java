...
public class BDMEvidenceUtilsTest extends CuramServerTestJUnit4 {
  ...
  public void testGetGenericSLDataDetails()
    ...
    key.evidenceID = 132466l;
    key.evidenceType = "ET10066";

    BDMEvidenceUtil.getGenericSLDataDetails(key);

  }

  public void testGetEndDateForEvidenceRecord()
    throws AppException, InformationalException {
    ...
    BDMEvidenceUtil.getEndDateForEvidenceRecord(key);

  }

  public void testSetDataAttributeNoCheck()
    throws AppException, InformationalException {

    final String attributeName = "Name";
    final String attributeValue = "123124";
    final DynamicEvidenceDataDetails dynamicEvidenceDataDetails =
      DynamicEvidenceDataDetailsFactory.newInstance("Meta_Version", null);

    BDMEvidenceUtil.setDataAttributeNoCheck(attributeName, attributeValue,
      dynamicEvidenceDataDetails);

  }

  public void testUpdateDynamicEvidenceDataDetails()
    throws AppException, InformationalException {
  ...
  /** Create Foreign Identification Evidence for country Specified */

  public EIEvidenceKey createForeignIdentificationEvidence(
    final PDCPersonDetails details, final String idNumber,
    final String idType, final boolean preferredInd, final String country)
    throws AppException, InformationalException {
    ...
    final DynamicEvidenceDataAttributeDetails preferred =
      dynamicEvidenceDataDetails.getAttribute(kPreferred);
    DynamicEvidenceTypeConverter.setAttribute(preferred, preferredInd);
    // Select Coiuntry for Foreign Identifiers
    final DynamicEvidenceDataAttributeDetails foreignCountry =
      dynamicEvidenceDataDetails.getAttribute("country");
    DynamicEvidenceTypeConverter.setAttribute(foreignCountry,
