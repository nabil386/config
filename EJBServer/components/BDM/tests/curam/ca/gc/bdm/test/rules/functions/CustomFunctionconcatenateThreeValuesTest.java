...
import curam.rules.functions.CustomFunctionconcatenateThreeValues;
...
public class CustomFunctionconcatenateThreeValuesTest
  ...
  /** The tested class. */
  @Tested
  CustomFunctionconcatenateThreeValues concatenate;

  /**
   * Instantiates a new CustomFunctionconcatenateTest.
   */
  public CustomFunctionconcatenateThreeValuesTest() {
  ...
  public void before() {
    ...
    concatenate = new CustomFunctionconcatenateThreeValues();
  ...
  public void test_concatenateStrings_Success()
    ...
    final String middleName = "Hugh ";
    final String lastName = "Smith";
    final String fullName = "James Hugh Smith";

    // Expectations
    expectationsParameters(firstName, middleName, lastName);
