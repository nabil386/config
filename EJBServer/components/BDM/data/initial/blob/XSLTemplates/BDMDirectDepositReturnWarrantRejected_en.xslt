		  ...
		  <fo:block>
			...
			<fo:table border="0"><fo:table-body><fo:table-row>
			  <fo:table-cell>
				...
				<fo:block xsl:use-attribute-sets="footer_text">
				  <fo:inline xsl:use-attribute-sets="footer_text">S070003-E</fo:inline>
				</fo:block>
			  </fo:table-cell>
		...
		<fo:block xsl:use-attribute-sets="Normal_8">
			...
			<fo:block xsl:use-attribute-sets="Normal_8">
				You can also call your Service Canada contact centre at
				 <xsl:apply-templates select="./FIELD[FNAME='processCtrPhoneDetails']/STRUCT[SNAME='BDMProcessingCenterPhoneNumbers']/FIELD[FNAME='phoneNumberEnquiries']" /> to correct your bank account information and enable direct deposit to
