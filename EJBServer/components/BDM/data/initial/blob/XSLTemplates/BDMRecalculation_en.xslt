...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:foa="http://fabio" version="1.0">
    ...
    <xsl:attribute-set name="Normal_7_indent" foa:class="block">
    <xsl:attribute name="font-size">11.0pt</xsl:attribute>
	<xsl:attribute name="space-before.optimum">10mm</xsl:attribute>
		  ...
		  <fo:block>
			...
			<fo:table border="0"><fo:table-body><fo:table-row>
			  <fo:table-cell>
				...
				<fo:block xsl:use-attribute-sets="footer_text">
				  <fo:inline xsl:use-attribute-sets="footer_text">N-03-00-00-F</fo:inline>
				</fo:block>
			  </fo:table-cell>
  ...
  <fo:block xsl:use-attribute-sets="Normal_7">
          ...
          <fo:block xsl:use-attribute-sets="Normal_8">
						We are writing to inform you about your Sample Benefit claim.
					</fo:block>
          <!-- 1 -->
          <xsl:if test="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='option1Ind' and VALUE='true']">
            <fo:block xsl:use-attribute-sets="Normal_8">
					   We have reviewed the new Notice of Assessment you submitted. This has resulted in no change to your weekly rate and the number of weeks payable.
					</fo:block>
          </xsl:if>
          <!-- 2-->
          <xsl:if test="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='option2Ind' and VALUE='true']">
            <fo:block xsl:use-attribute-sets="Normal_8">
               We have reviewed the new Notice of Assessment you submitted. As a result, your weekly benefit rate has changed to $
              <xsl:apply-templates select="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='currentRate']"/>
                            - current rate
					
					instead of $
              <xsl:apply-templates select="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='previousRate']"/>
                            - previous rate, 
					 and the maximum number of weeks payable on your claim has changed to 
              
              <xsl:apply-templates select="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='currentDuration']"/> week(s)
              - current
					 instead of
              
              <xsl:apply-templates select="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='previousDuration']"/>
               week(s)
              -previous. 
          ...
          <!-- 3 -->
          <xsl:if test="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='option3Ind' and VALUE='true']">
            <fo:block xsl:use-attribute-sets="Normal_8">
					   We have reviewed the calculation of your claim. This has resulted in no change to your weekly rate and the number of weeks payable. 
					</fo:block>
          </xsl:if>
          <!-- 4 -->
          <xsl:if test="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='option4Ind' and VALUE='true']">
            <fo:block xsl:use-attribute-sets="Normal_8">
                            We have reviewed the calculation of your claim. As a result, your weekly benefit rate has changed to $<xsl:apply-templates select="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='currentRate']"/>
                            -current rate
					 instead of $<xsl:apply-templates select="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='previousRate']"/>
                            -previous rate, 
					and the maximum number of weeks payable on your claim has changed to <xsl:apply-templates select="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='currentDuration']"/>
               week(s)
              -current 
					instead of 
          ...
          <!-- 5 -->
          <xsl:if test="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='option5Ind' and VALUE='true']">
            <fo:block xsl:use-attribute-sets="Normal_8">
					   <xsl:apply-templates select="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='inAdditionString']"/> have reviewed your entitlement to the dependant supplement. If we have not paid you all the supplement you are entitled to, then you will receive an adjustment for the weeks already paid. 
					</fo:block>
          </xsl:if>
          <!-- 6 -->
          <xsl:if test="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='option6Ind' and VALUE='true']">
            <fo:block xsl:use-attribute-sets="Normal_8">
					    <xsl:apply-templates select="./FIELD[FNAME='recalculationDtls']/STRUCT[SNAME='BDMRecalculationOptions']/FIELD[FNAME='inAdditionString']"/> have reviewed your entitlement to the dependant supplement. If we have paid you more supplement than you are entitled to, it means we have overpaid you. If this is the case, we will notify you about it later. 
					</fo:block>
          </xsl:if>
          <fo:block xsl:use-attribute-sets="Normal_8">
