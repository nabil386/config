...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:foa="http://fabio" version="1.0">
		  ...
		  <fo:block>
			...
			<fo:table border="0"><fo:table-body><fo:table-row>
			  <fo:table-cell>
				...
				<fo:block xsl:use-attribute-sets="footer_text">
				  <fo:inline xsl:use-attribute-sets="footer_text">Q000000-E</fo:inline>
				</fo:block>
			  </fo:table-cell>
   ...
   <fo:block xsl:use-attribute-sets="Normal_8">
     ...
     <fo:inline font-weight="bold"> Direct deposit</fo:inline> is fast, convenient and secure. Register for <fo:inline font-weight="bold">direct deposit</fo:inline> today to 
	...
	<fo:inline font-weight="bold">
	 Click </fo:inline><fo:inline text-decoration="underline"> www.canada.ca/en/employment-social-development/services/my-account.html</fo:inline>
	</fo:block>
