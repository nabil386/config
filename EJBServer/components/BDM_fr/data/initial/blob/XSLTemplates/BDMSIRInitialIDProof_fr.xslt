...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:foa="http://fabio" version="1.0">
		  ...
		  <fo:block>
			...
			<fo:table border="0"><fo:table-body><fo:table-row>
			  <fo:table-cell>
				...
				<fo:block xsl:use-attribute-sets="footer_text">
				  <fo:inline xsl:use-attribute-sets="footer_text">S010000-F</fo:inline>
				</fo:block>
			  </fo:table-cell>
   ...
   <fo:block xsl:use-attribute-sets="Normal_8">
	 ...
	 <fo:block xsl:use-attribute-sets="Normal_8">
Please visit your Service Canada Centre and present personal identification, along with this letter, to one of our agents. If you do not, your application for benefits may be cancelled.
</fo:block>
<fo:block xsl:use-attribute-sets="Normal_8">
Please see below for a description of acceptable identity documents. Please submit acceptable identity documentation.  Original primary identity documents such as your Birth Certificate issued by a Provincial/Territorial Vital Statistics Office, Certificate of Canadian Citizenship, Permanent Resident Card, Work permit, or Student permit may be used as personal identification.
</fo:block>
<fo:block xsl:use-attribute-sets="Normal_8">
...
<fo:block xsl:use-attribute-sets="Normal_8">
To find additional information on which documents must be provided as personal identification contact one of our Service Delivery Representatives at 1-866-274-6627.
</fo:block>
