...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:foa="http://fabio" version="1.0">
		  ...
		  <fo:block>
			...
			<fo:table border="0"><fo:table-body><fo:table-row>
			  <fo:table-cell>
				...
				<fo:block xsl:use-attribute-sets="footer_text">
				  <fo:inline xsl:use-attribute-sets="footer_text">S010002-F</fo:inline>
				</fo:block>
			  </fo:table-cell>
   ...
   <fo:block xsl:use-attribute-sets="Normal_8">
	 ...
	 <fo:block xsl:use-attribute-sets="Normal_8">
To correct the situation, you must complete a Social Insurance Number application (NAS 2120) to amend the personal information on your Social Insurance Number record. Failure to amend your Social Insurance Number record will not delay your application for benefits, at present. However, you should amend your Social Insurance Number record to avoid any complications in the future.
</fo:block>
<fo:block xsl:use-attribute-sets="Normal_8">
Specific types of original identification documents are required to amend your Social Insurance Number record and/or card.  These documents include your birth certificate (issued by the provincial vital statistics office), your Certificate of Canadian Citizenship or your Permanent Resident Card.  If the birth certificate does not show the name as the Social Insurance Number card and the name change is because of marriage, please supply a Marriage Certificate as well as the birth certificate.  For more information on what documents you can use, please contact us at 1-866-274-6627 or consult the Social Insurance Number web site at <fo:inline text-decoration="underline"> www.canada.ca/en/employment-social-development/services/sin.html.</fo:inline>
</fo:block>
<fo:block xsl:use-attribute-sets="Normal_9">Yours sincerely,</fo:block>
		<fo:block xsl:use-attribute-sets="Normal_9">Service Canada</fo:block>
	</fo:flow>
      </fo:page-sequence>
    </fo:root>
  </xsl:template>
