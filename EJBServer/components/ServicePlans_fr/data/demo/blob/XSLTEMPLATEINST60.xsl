...
<!-- BEGIN, CR00352142, PB -->
    <fo:block xsl:use-attribute-sets="Normal_1" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="center" text-indent="0.0pt">
      <fo:inline xsl:use-attribute-sets="Normal_2">Contrat de plan de service</fo:inline>
    </fo:block>
    ...
    <fo:block wrap-option="wrap" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline xsl:use-attribute-sets="Normal_3">
        Nom du client : <xsl:apply-templates select="FIELD[FNAME='clientName']" />
      </fo:inline>
      <fo:inline xsl:use-attribute-sets="Normal_3">
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Numéro de sécurité sociale : <xsl:apply-templates select="FIELD[FNAME='ssnNumber']" />
      </fo:inline>
    </fo:block>
    <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline xsl:use-attribute-sets="Normal_3">
        Date du contrat : <xsl:apply-templates select="FIELD[FNAME='contractDate']" />
      </fo:inline>
      <fo:inline xsl:use-attribute-sets="Normal_3">
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Numéro de référence du plan : <xsl:apply-templates select="FIELD[FNAME='caseReference']" />
      </fo:inline>
    </fo:block>
    ...
    <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline xsl:use-attribute-sets="Normal_3">
        But du plan : <xsl:apply-templates select="FIELD[FNAME='plannedGoalName']" />
      </fo:inline>
    </fo:block>
    <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
      <fo:inline xsl:use-attribute-sets="Normal_3">
    ...
    <xsl:if test="count(FIELD[FNAME='ObjectiveSubGoalDetails']/STRUCT[SNAME='ObjectivePlannedSubGoalDetails']/FIELD[FNAME='subGoalDtlsForContractList']/STRUCT_LIST/STRUCT) &gt; 0">
      <fo:block xsl:use-attribute-sets="Normal_4" border="1px solid blue" background-color="white" text-align="center">Objectifs</fo:block>
	...
	<!-- BEGIN, CR00357029, PB -->
      <fo:block xsl:use-attribute-sets="Normal_4" border="1px solid blue" background-color="white" text-align="center">Obstacles</fo:block>
	  <!-- END, CR00357029 -->
      <fo:block font-size="5.0pt" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">&nbsp;</fo:block>
    ...
    <xsl:if test="count(FIELD[FNAME='NeedSubGoalDetails']/STRUCT[SNAME='NeedPlannedSubGoalDetails']/FIELD[FNAME='subGoalDtlsForContractList']/STRUCT_LIST/STRUCT) &gt; 0">
      <fo:block xsl:use-attribute-sets="Normal_4" border="1px solid blue" background-color="white" text-align="center">Besoins</fo:block>
      <fo:block font-size="5.0pt" margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">&nbsp;</fo:block>
          ...
          <fo:table-body>
            <fo:table-row>
              <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-left="5.4pt" padding-right="5.4pt">
                <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
                  <fo:inline xsl:use-attribute-sets="Normal_5">Elément de plan</fo:inline>
                </fo:block>
              </fo:table-cell>
              <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-left="5.4pt" padding-right="5.4pt">
                <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
                  <fo:inline xsl:use-attribute-sets="Normal_5">Début</fo:inline>
                </fo:block>
              </fo:table-cell>
              <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-left="5.4pt" padding-right="5.4pt">
                <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
                  <fo:inline xsl:use-attribute-sets="Normal_5">Fin</fo:inline>
                </fo:block>
              </fo:table-cell>
            </fo:table-row>
        ...
        <fo:table table-layout="fixed" width="100%">
          <fo:table-body>
            ...
            <fo:table-row>
              <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-left="2.4pt" padding-right="2.4pt" number-columns-spanned="3">            
                <fo:block margin-left="0.0pt" space-after="0.0pt" space-before="0.0pt" text-align="start" text-indent="0.0pt">
                  <fo:inline xsl:use-attribute-sets="Normal_5">Commentaires&nbsp;:&nbsp;</fo:inline>
                  <fo:inline xsl:use-attribute-sets="Normal_3">
