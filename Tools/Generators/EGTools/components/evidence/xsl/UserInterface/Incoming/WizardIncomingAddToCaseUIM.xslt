...
<xsl:output method="xml" indent="yes"/>
  ...
  <!--
    Template to write a wizard IncomingAddToCase page for an entity.
  ...
  -->
  <xsl:template name="WizardIncomingAddToCaseUIM">
    ...
    <redirect:write select="concat($fullFileName, '.uim')">
      ...
      <PAGE
		...
		<!-- If end date wizard enabled then link end date page to "Next" and -->
          ...
          >
            <xsl:call-template name="linkToPageIncomingAddToCase">
    ...
    <xsl:call-template name="write-all-locales-wizardIncomingAddToCaseuim-properties">
  ...
  <xsl:template name="write-all-locales-wizardIncomingAddToCaseuim-properties">
    ...
    <xsl:if test="$locales">
      ...
      <xsl:choose>
        ...
        <xsl:when test="contains($locales,',')">
          ...
          <xsl:call-template name="write-wizardIncomingAddToCaseuim-properties">
  ...
  <!-- BEGIN, CR00266438, CD -->
  <xsl:template name="linkToPageIncomingAddToCase">
    ...
    <LINK PAGE_ID="{$pageUIMName}" DISMISS_MODAL="FALSE" SAVE_LINK="FALSE">
      ...
      <!-- Added evidenceType & evidenceID of incoming evidence -->
      <CONNECT>
  ...
  <xsl:template name="write-wizardIncomingAddToCaseuim-properties">
