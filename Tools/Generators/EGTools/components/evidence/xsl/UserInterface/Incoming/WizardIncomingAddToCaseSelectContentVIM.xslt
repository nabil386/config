...
<xsl:stylesheet extension-element-prefixes="redirect xalan"
  ...
  <!--
    ...
    @param fileName Name of the file to addToCase (with no file extension)
    @param relatedEntityName The name of the entity that was pre selected (if any)
  -->
  <xsl:template name="WizardIncomingAddToCaseSelectContentVIM">
    ...
    <!-- Full name and directory of the file to addToCase, minus the file extension -->
