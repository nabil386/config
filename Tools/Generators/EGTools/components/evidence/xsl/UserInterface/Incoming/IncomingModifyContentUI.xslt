...
<xsl:template name="IncomingModifyContentUI">
  <xsl:param name="path" />
  ...
  <xsl:variable name="facadeModifyMethod">incomingModify<xsl:value-of select="$EntityName"/>Evidence</xsl:variable>

  <!-- <xsl:variable name="facadeViewMethod">
    <xsl:choose>
      <xsl:when test="flagForCreateRelatedParticipantOnModify='Yes'">read<xsl:value-of select="$EntityName"/>EvidenceFromIncomingModify</xsl:when>
      <xsl:otherwise>read<xsl:value-of select="$EntityName"/>Evidence</xsl:otherwise>
    </xsl:choose>
  </xsl:variable> -->

  <xsl:variable name="facadeViewMethod">read<xsl:value-of select="$EntityName"/>EvidenceForIncomingModify</xsl:variable>
...
<!-- end, ciaran -->
  ...
  <xsl:call-template name="IncomingModifyContentUI-WriteClusters">
  ...
  <xsl:call-template name="write-all-locales-incoming-modify-content-properties">
...
<xsl:template name="IncomingModifyContentUI-WriteClusters">
...
<!-- BEGIN, PADDY -->
  ...
  <!--iterate through each token, generating each element-->
    <xsl:template name="write-all-locales-incoming-modify-content-properties">
       ...
       <xsl:if test="$locales">
         ...
         <xsl:choose>
           ...
           <xsl:when test="contains($locales,',')">
             ...
             <xsl:call-template name="write-incoming-modify-content-properties">
    ...
    <xsl:template name="write-incoming-modify-content-properties">
