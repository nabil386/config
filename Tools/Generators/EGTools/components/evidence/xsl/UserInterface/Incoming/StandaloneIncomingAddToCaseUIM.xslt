...
-->
<xsl:template name="StandaloneIncomingAddToCaseUIM">
...
>
  ...
  <xsl:call-template name="write-all-locales-standaloneIncomingAddToCaseuim-properties">
  ...
  <xsl:template name="write-all-locales-standaloneIncomingAddToCaseuim-properties">
       ...
       <xsl:if test="$locales">
         ...
         <xsl:choose>
           ...
           <xsl:when test="contains($locales,',')">
             ...
             <xsl:call-template name="write-standaloneIncomingAddToCaseuim-properties">
  ...
  <xsl:template name="write-standaloneIncomingAddToCaseuim-properties">
